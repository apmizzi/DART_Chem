...
%
%exp         = '/real_FRAPPE_CONTROL_NASA/obs_diag_output_surface.nc';
exp         = '/real_FRAPPE_ALLCHEM_NASA/obs_diag_output_surface.nc';
%exp         = '/real_FRAPPE_ALLCHEM_RELAX/obs_diag_output_surface.nc';
%
