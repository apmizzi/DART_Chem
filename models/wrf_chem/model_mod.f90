...
!
! APM +++                                                                        
   integer :: type_so2, type_o3_column, type_o3, type_co, type_co2, type_no, &
...
! APM +++
   ...
   wrf%dom(id)%type_co2  = get_type_ind_from_type_string(id,'co2')
...
! APM +++ 
integer             :: kaod, zk_aod
real(r8)            :: aod1(ens_size),aod2(ens_size),aod3(ens_size),aod4(ens_size), &
                       aod5(ens_size),ang(ens_size)
! APM ---
!
real(r8) :: a1(ens_size) 
...
call nc_check(nf90_def_var(ncid, name='DY', xtype=nf90_real, &
             varid=DYVarID),'nc_write_model_atts','def_var DY')
...
call nc_check(nf90_def_var(ncid, name='TRUELAT1', xtype=nf90_real, &
             varid=TRUELAT1VarID),'nc_write_model_atts','def_var TRUELAT1')
