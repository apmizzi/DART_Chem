...
#########################################################################
#
# Purpose: Create DART &obs_def_TES_O3_nml 
#
#########################################################################
#
...
cat > input.nml_temp << EOF
 &obs_def_TES_O3_nml
   ...
   nlayer_tes_o3_total_col  = ${NL_NLAYER_TES_O3_TOTAL_COL:-67},
   nlayer_tes_o3_trop_col   = ${NL_NLAYER_TES_O3_TROP_COL:-67},
   nlayer_tes_o3_profile    = ${NL_NLAYER_TES_O3_PROFILE:-67},
/ 
EOF
#
