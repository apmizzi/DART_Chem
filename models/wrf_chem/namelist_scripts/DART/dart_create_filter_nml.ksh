...
cat > input.nml_temp << EOF
 &filter_nml
   ...
   inf_sd_initial               = ${NL_INF_SD_INITIAL_PRIOR:-0.60}, ${NL_INF_SD_INITIAL_POST:-0.60},
   inf_sd_lower_bound           = ${NL_INF_SD_LOWER_BOUND_PRIOR:-0.60}, ${NL_INF_SD_LOWER_BOUND_POST:-0.60},
   inf_sd_max_change             = ${NL_INF_SD_MX_CHANGE_PRIOR:-1.05}, ${NL_INF_SD_MX_CHANGE_POST:-1.05},
   inf_damping                  = ${NL_INF_DAMPING_PRIOR:-0.90}, ${NL_INF_DAMPING_POST:-0.90},
