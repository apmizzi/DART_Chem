...
&create_gome2a_obs_nml
   ...
   obs_no2_reten_freq          = ${NL_GOME2A_NO2_RETEN_FREQ}
/
&obs_sequence_nml
...
&obs_def_GOME2A_NO2_nml
   ...
   nlayer_gome2a_no2_total_col  = ${NL_NLAYER_GOME2A_NO2_TOTAL_COL:-14},
   nlayer_gome2a_no2_trop_col   = ${NL_NLAYER_GOME2A_NO2_TROP_COL:-14},
/ 
EOF
