...
/
 &obs_def_OMI_O3_nml
   ...
   nlayer_omi_o3_total_col = ${NL_NLAYER_OMI_O3_TOTAL_COL:-35},
   nlayer_omi_o3_trop_col  = ${NL_NLAYER_OMI_O3_TROP_COL:-35},
   nlayer_omi_o3_profile   = ${NL_NLAYER_OMI_O3_PROFILE:-35},
/
 &obs_def_OMI_NO2_nml
