...
rm -f create_mexico_aqs_obs_nml.nl
touch create_mexico_aqs_obs_nml.nl
cat > create_mexico_aqs_obs_nml.nl << EOF
&create_mexico_aqs_obs_nml
   beg_year=${BIN_BEG_YR}
   beg_mon=${BIN_BEG_MM}
   beg_day=${BIN_BEG_DD}
   beg_hour=${BIN_BEG_HH}
   ...
   end_min=${BIN_END_MN}
   end_sec=${BIN_END_SS}
   file_in_stations=${NL_FILENAME_STATIONS}
