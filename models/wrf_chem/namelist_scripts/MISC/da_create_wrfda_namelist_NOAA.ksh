...
radt                                = ${NL_RADT},
aer_opt                             = 2,   ! add this
topo_shading                        = 1,   ! add this
shadlen                             = 25000., !  add this
...
iz0tlnd                             = 1,                                ! Chen-Zhang thermal roughness length over land, which depends on vegetation heigh
/
&fdda
/
&dfi_control
