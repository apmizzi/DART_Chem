...
step_to_output_time                 = ${NL_STEP_TO_OUTPUT_TIME:-.false.},
target_cfl                          = ${NL_TARGET_CFL:-1.2},
target_hcfl                         = ${NL_TARGET_HCFL:-0.84},
max_step_increase_pct               = ${NL_MAX_STEP_INCREASE:-5},
starting_time_step                  = ${NL_STARTING_TIME_STEP:-20},
starting_time_step_den              = ${NL_STARTING_TIME_STEP_DEN:-1},
max_time_step                       = ${NL_MAX_TIME_STEP:-30},
max_time_step_den                   = ${NL_MAX_TIME_STEP_DEN:-1},
min_time_step                       = ${NL_MIN_TIME_STEP:-10},
min_time_step_den                   = ${NL_MIN_TIME_STEP_DEN:-1},
max_dom                             = ${NL_MAX_DOM},
s_we                                = ${NL_S_WE},
e_we                                = ${NL_E_WE},
s_sn                                = ${NL_S_SN},
