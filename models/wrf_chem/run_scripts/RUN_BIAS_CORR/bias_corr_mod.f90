...
!
   character(len=150) :: path_output, path_data, file_in, correction_filename
   character(len=150), dimension(maxkinds) :: obs_list 
!
   logical :: does_file_exist
   namelist /bias_correct_nml/does_file_exist,correction_filename,nobs,obs_list
!
   contains   
!
   ...
   ! initialize counters
      ...
      airnow_pm25_cnt=0
      iunit=101
      open(unit=iunit,form='formatted',file=file_in) 
   !
   ! read file type
