...
# DEPENDENT INPUT DATA DIRECTORIES:
   ...
   export RUN_DIR=${EXPERIMENT_DIR}/real_TRACER_1_CONTROL
...
# SELECT COMPONENT RUN OPTIONS:
   if [[ ${RUN_SPECIAL_FORECAST} = "false" ]]; then
      ...
      export RUN_TES_CO_PROFILE_OBS=false # (done, vertical sum)
      ...
      export RUN_TES_O3_PROFILE_OBS=false # (done, vertical sum)
      ...
      export RUN_MLS_O3_PROFILE_OBS=true # (done, vertical sum)
...
#
# All files present
      if [[ ${NL_NUM_INPUT_FILES} -eq 90 ]]; then
