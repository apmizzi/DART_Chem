...
#
#export INITIAL_DATE=2022072518
#export FIRST_FILTER_DATE=2022072600
#export FIRST_DART_INFLATE_DATE=2022072600
#export FIRST_EMISS_INV_DATE=2022072600
#
...
export NL_FAC_OBS_ERROR_TROPOMI_CH4=1.40
export NL_FAC_OBS_ERROR_TROPOMI_HCHO=1.40
...
# SELECT COMPONENT RUN OPTIONS:
   if [[ ${RUN_SPECIAL_FORECAST} = "false" ]]; then
      ...
      export RUN_OMI_SO2_PBL_COL_OBS=false # (done)
      export RUN_OMI_HCHO_TOTAL_COL_OBS=false # (done)
      ...
      export RUN_TROPOMI_NO2_TROP_COL_OBS=false # (done)
      export RUN_TROPOMI_SO2_TOTAL_COL_OBS=false
      export RUN_TROPOMI_SO2_PBL_COL_OBS=false # (done, vertical sum)
      export RUN_TROPOMI_CH4_TOTAL_COL_OBS=false  # (done, vertical sum)
      ...
      export RUN_TROPOMI_HCHO_TROP_COL_OBS=false # (done, vertical sum)
      ...
      export RUN_TES_CO_PROFILE_OBS=false # (done)
      export RUN_TES_CO_CPSR_OBS=false # (done)
      export RUN_TES_CO2_TOTAL_COL_OBS=false 
      export RUN_TES_CO2_PROFILE_OBS=false # (done, vertical sum)
      export RUN_TES_CO2_CPSR_OBS=false # (done, vertical sum)
      export RUN_TES_O3_TOTAL_COL_OBS=false
      export RUN_TES_O3_PROFILE_OBS=false # (done)
      export RUN_TES_O3_CPSR_OBS=false # (done)
      export RUN_TES_NH3_TOTAL_COL_OBS=false
      export RUN_TES_NH3_PROFILE_OBS=false # (done, vertical sum)
      export RUN_TES_NH3_CPSR_OBS=false # (done, vertical sum)
      export RUN_TES_CH4_TOTAL_COL_OBS=false
      export RUN_TES_CH4_PROFILE_OBS=false # (done, vertical sum)
      export RUN_TES_CH4_CPSR_OBS=false # (done, vertical sum)
      export RUN_CRIS_CO_TOTAL_COL_OBS=false
      export RUN_CRIS_CO_PROFILE_OBS=false # (done, vertical sum)
      export RUN_CRIS_CO_CPSR_OBS=false # (done, vertical sum)
      export RUN_CRIS_O3_TOTAL_COL_OBS=false
      export RUN_CRIS_O3_PROFILE_OBS=false # (done, vertical sum)
      export RUN_CRIS_O3_CPSR_OBS=false # (done, vertical sum)
      export RUN_CRIS_NH3_TOTAL_COL_OBS=false
      export RUN_CRIS_NH3_PROFILE_OBS=false # (done, vertical sum)
      export RUN_CRIS_NH3_CPSR_OBS=false # (done, vertical sum)
      export RUN_CRIS_CH4_TOTAL_COL_OBS=false
      export RUN_CRIS_CH4_PROFILE_OBS=false # (done, vertical sum)
      export RUN_CRIS_CH4_CPSR_OBS=false # (done, vertical sum)
      export RUN_CRIS_PAN_TOTAL_COL_OBS=false # (done, vertical sum)
      export RUN_CRIS_PAN_PROFILE_OBS=false 
      export RUN_CRIS_PAN_CPSR_OBS=false
      export RUN_SCIAM_NO2_TOTAL_COL_OBS=false
      export RUN_SCIAM_NO2_TROP_COL_OBS=false # (done, vertical sum)
      export RUN_GOME2A_NO2_TOTAL_COL_OBS=false
      export RUN_GOME2A_NO2_TROP_COL_OBS=false # (done, vertical sum)
      export RUN_MLS_O3_TOTAL_COL_OBS=false
      export RUN_MLS_O3_PROFILE_OBS=false # (done, vertical sum)
      export RUN_MLS_O3_CPSR_OBS=false # (done, vertical sum)
      export RUN_MLS_HNO3_TOTAL_COL_OBS=false
      export RUN_MLS_HNO3_PROFILE_OBS=false # (done, vertical sum)
      export RUN_MLS_HNO3_CPSR_OBS=false # (done, vertical sum)
...
#
# SET OMI PARAMETERS
### APM: TEMPORARY CHANGE FOR DEVELOPING FO      
###      export NL_PATH_MODEL=\'${RUN_DIR}/${PAST_DATE}/ensemble_mean_output\'
###      export NL_FILE_MODEL=\'wrfout_d${CR_DOMAIN}_${DATE}_mean\'
      export NL_PATH_MODEL=${RUN_DIR}/2020${PAST_MM}${PAST_DD}${PAST_HH}/ensemble_mean_output
      export NL_FILE_MODEL=wrfout_d${CR_DOMAIN}_2020${MM}${DD}${HH}_mean
      export NL_NX_MODEL=${NNXP_CR}
      export NL_NY_MODEL=${NNYP_CR}
      export OMI_FILE_PRE=OMI-Aura_L2-OMHCHO_
      export OMI_FILE_EXT=.he5
...
#
# APM: TEMPORARY FOR TESTING CRIS	  
#      export DATE_TEMP=${DATE}
#      export PAST_DATE_TEMP=${PAST_DATE}	  
#      export DATE=2014072618
#      export PAST_DATE=2014072612
#
...
# GET INPUT DATA
      rm -rf obs_seq.old
      rm -rf obs_seq.new
# APM: TEMPORARY FIX FOR TESTING CRIS
      cp ${COMBINE_OBS_DIR}/obs_seq_comb_${DATE}.out obs_seq.old
#      cp ${COMBINE_OBS_DIR}/obs_seq_comb_${DATE_TEMP}.out obs_seq.old
#
      rm -rf job.ksh
      touch job.ksh
      cat << EOF > job.ksh
