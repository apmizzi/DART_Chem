...
export CYCLE_STR_DATE=2020071012
#
# END CYCLE DATE-TIME:
export CYCLE_END_DATE=2020071012
...
# DEPENDENT INPUT DATA DIRECTORIES:
   ...
   export RUN_DIR=${EXPERIMENT_DIR}/real_FIREX_MOPITT_CO_BCR_v4
...
#
# &obs_kind_nml
   export NL_EVALUATE_THESE_OBS_TYPES="'TROPOMI_CO_COLUMN',
                                       'AIRNOW_CO'"
#
...
#
   if ${RUN_BIAS_CORRECTION}; then
      ...
      rm -rf obs_seq.final
      cp ${BIAS_CORR_DIR}/work/bias_corr.exe ./.
...
# Run bias corrections
      ./bias_corr.exe > index_bias_corr 2>&1
   fi
#
#########################################################################
#
