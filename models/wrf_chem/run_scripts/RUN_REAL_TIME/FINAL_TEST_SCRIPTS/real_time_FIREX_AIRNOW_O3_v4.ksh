...
export CYCLE_STR_DATE=2020071100
#
# END CYCLE DATE-TIME:
export CYCLE_END_DATE=2020071200
...
# DEPENDENT INPUT DATA DIRECTORIES:
   ...
   export RUN_DIR=${EXPERIMENT_DIR}/real_FIREX_AIRNOW_O3_v4
...
#
# &obs_kind_nml
   export NL_EVALUATE_THESE_OBS_TYPES="'TROPOMI_NO2_COLUMN',
                                       'TEMPO_NO2_COLUMN',
                                       'AIRNOW_NO2'"
#
