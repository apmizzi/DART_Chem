...
export INPUT_DATA_DIR=${WORK_DIR}/INPUT_DATA
export EXPERIMENT_DATA_DIR=${INPUT_DATA_DIR}/2008CASE_REAL_TIME_DATA
...
export PERT_CHEM_EMISS_DIR=${DART_DIR}/models/wrf_chem/run_scripts/RUN_PERT_CHEM/EMISS_PERT/work
#
...
#
      export TIME_INTERP_DIR1=${WORK_DIR}/${DART_VER}/models/wrf_chem
...
# LINK NEEDED FILES
      ...
      ln -sf ${REAL_DIR}/${FILE_CR}_${FILE_DATE} ${FILE_CR}   
      rm -rf GLOBAL*.txt
      ln -sf ${EXPERIMENT_WRFFIRECHEMI_DIR}/GLOB_*.txt ./.
...
mopitt_extract_no_transform_RT, ${MOP_INFILE}, ${MOP_OUTFILE}, ${BIN_BEG_SEC}, ${BIN_END_SEC}, ${NL_MIN_LON}, ${NL_MAX_LON}, ${NL_MIN_LAT}, ${NL_MAX_LAT}
EOF
export RC=\$?     
