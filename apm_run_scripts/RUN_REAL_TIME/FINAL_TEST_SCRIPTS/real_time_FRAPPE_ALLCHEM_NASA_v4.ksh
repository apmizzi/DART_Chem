...
# SELECT COMPONENT RUN OPTIONS:
   if [[ ${RUN_SPECIAL_FORECAST} = "false" ]]; then
      ...
      export RUN_MOPITT_CO_PROFILE_OBS=false # true # (works)
      ...
      export RUN_MODIS_AOD_TOTAL_COL_OBS=false # (works)
      export RUN_OMI_O3_TOTAL_COL_OBS=false
      export RUN_OMI_O3_TROP_COL_OBS=false
      export RUN_OMI_O3_PROFILE_OBS=false # true # (works)
      ...
      export RUN_OMI_NO2_DOMINO_TROP_COL_OBS=false # true # (works)
      ...
      export RUN_TES_CO_PROFILE_OBS=false # true # (done)
      ...
      export RUN_TES_O3_PROFILE_OBS=false # true # (done)
      ...
      export RUN_GOME2A_NO2_TROP_COL_OBS=false # works # (done, vertical sum)
      export RUN_MLS_O3_TOTAL_COL_OBS=false
      export RUN_MLS_O3_PROFILE_OBS=false # true # (done, works/check)
      export RUN_MLS_O3_CPSR_OBS=false # (done, vertical sum)
      export RUN_MLS_HNO3_TOTAL_COL_OBS=false
      export RUN_MLS_HNO3_PROFILE_OBS=false # true # (done, vertical sum)
