...
#########################################################################
#
export INITIAL_DATE=2020071400
export FIRST_FILTER_DATE=2020071406
export FIRST_DART_INFLATE_DATE=2020071406
export FIRST_EMISS_INV_DATE=2020071406
...
export NL_TROPOMI_CO_RETEN_FREQ=4
export NL_TROPOMI_O3_RETEN_FREQ=4
export NL_TROPOMI_NO2_RETEN_FREQ=4
export NL_TROPOMI_SO2_RETEN_FREQ=4
export NL_TROPOMI_CH4_RETEN_FREQ=4
export NL_TROPOMI_HCHO_RETEN_FREQ=4
...
# DEPENDENT INPUT DATA DIRECTORIES:
   ...
   export RUN_DIR=${EXPERIMENT_DIR}/real_FIREX_ALLCHEM
...
#   export PERT_CHEM_INPUT_DIR=${DART_DIR}/apm_run_scripts/RUN_PERT_CHEM/ICBC_PERT
   export PERT_CHEM_INPUT_DIR=${DART_DIR}/apm_run_scripts/RUN_PERT_CHEM/ICBC_PERT_v2
...
# SELECT COMPONENT RUN OPTIONS:
   if [[ ${RUN_SPECIAL_FORECAST} = "false" ]]; then
      ...
      export RUN_TEMPO_O3_CPSR_OBS=true  # (working on this)
...
# SET TROPOMI INPUT DATA FILE
      export TRP_INFILE=\'${EXPERIMENT_TROPOMI_NO2_DIR}/${YYYY}${MM}${DD}/${TROPOMI_FILE_PRE}${YYYY}${MM}${DD}T\'
#
# COPY EXECUTABLE
...
# END OF PREVIOUS DAY (hours 21 to 24 obs)
      if [[ ${FLG} -eq 1 ]]; then
         ...
         export BIN_END_MN=59
         export BIN_END_SS=59
	 export TRP_INFILE=\'${EXPERIMENT_TROPOMI_NO2_DIR}/${YYYY}${MM}${DD}/${TROPOMI_FILE_PRE}${ASIM_MN_YYYY}${ASIM_MN_MM}${ASIM_MN_DD}T\'
#
# COPY EXECUTABLE
         export FILE=tropomi_no2_total_col_extract.m
         rm -rf ${FILE}
...
#
# SET TROPOMI INPUT DATA FILE
      export TRP_INFILE=\'${EXPERIMENT_TROPOMI_CH4_DIR}/${YYYY}${MM}${DD}/${TROPOMI_FILE_PRE}${YYYY}${MM}${DD}T\'
#
# COPY EXECUTABLE
...
# END OF PREVIOUS DAY (hours 21 to 24 obs)
      if [[ ${FLG} -eq 1 ]]; then	 
         ...
         export BIN_END_MN=59
         export BIN_END_SS=59
         export TMP_INFILE=\'${EXPERIMENT_TEMPO_NO2_DIR}/${YYYY}${MM}${DD}/${TEMPO_FILE_PRE}${ASIM_MN_YYYY}${ASIM_MN_MM}${ASIM_MN_DD}T\'
#
# COPY EXECUTABLE
         export FILE=tempo_no2_total_col_extract.m
         rm -rf ${FILE}
