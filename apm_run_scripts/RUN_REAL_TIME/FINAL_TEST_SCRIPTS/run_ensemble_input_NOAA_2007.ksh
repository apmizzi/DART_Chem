...
#
export RUN_DIR=${EXPERIMENT_DIR}/INPUT_DATA_NOAA_2007
export RUN_INPUT_DIR=${EXPERIMENT_DIR}/INPUT_DATA_NOAA_2007
...
export INITIAL_DATE=2007040200
export FIRST_FILTER_DATE=2007040203
export FIRST_DART_INFLATE_DATE=2007040203
export FIRST_EMISS_INV_DATE=2007040203
#
# START CYCLE DATE-TIME:
export CYCLE_STR_DATE=2007040200
#
# END CYCLE DATE-TIME:
export CYCLE_END_DATE=2007040200
#
...
#
   ...
   export RUN_GOME2B_NO2_TROP_COL_OBS=true           # (check)  TRACER I
...
#   export WRFCHEM_VER=WRFCHEMv4.3.2_dmparr
   export EXPERIMENT_HIST_IO_DIR=/nobackupp27/nex/datapool/TRACER-1/TRACER1_OBS/hist_io_files
   export EXPERIMENT_COLDENS_DIR=/nobackupp27/nex/datapool/TRACER-1/TRACER1_OBS/wes_coldens
   ...
   export NL_FIRE_FILE=GLOBAL_FINNv15_2007_MOZ4_7112014.txt
...
#
   if ${RUN_PERT_WRFCHEM_CHEM_EMISS}; then
      ...
      export NL_CHEM_ANTHRO_EMIS='E_ACT','E_CH4','E_CO','E_ECI','E_ECJ','E_EOH','E_ETEG','E_ETH','E_HC3','E_HC5','E_HC8','E_HCHO','E_HONO','E_ISO','E_KET','E_NH3','E_NO','E_NO2','E_OL2','E_OLI','E_OLT','E_ORA2','E_ORGI','E_ORGJ','E_SO2','E_TERP','E_TOL','E_UNID','E_XYL'
      export NL_CHEM_FIRE_EMIS='ebu_in_co','ebu_in_no','ebu_in_no2','ebu_in_so2','ebu_in_c2h4','ebu_in_ch2o','ebu_in_ch3oh','ebu_in_nh3'
