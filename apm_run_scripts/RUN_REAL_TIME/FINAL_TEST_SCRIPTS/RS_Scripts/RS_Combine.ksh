...
#
# MOPITT CO PROFILE
      if [[ -s ${MOPITT_CO_PROFILE_OBS_DIR}/obs_seq_mopitt_co_profile_${DATE}.out && (${RUN_MOPITT_CO_PROFILE_OBS} == true || ${RUN_MOPITT_V8_CO_PROFILE_OBS} == true || ${RUN_MOPITT_V9_CO_PROFILE_OBS} == true) ]]; then
