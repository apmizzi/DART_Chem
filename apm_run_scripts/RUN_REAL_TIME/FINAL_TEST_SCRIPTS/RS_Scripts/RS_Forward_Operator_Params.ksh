...
# Forward operator parameters
   ...
   export NL_NLAYER_TES_CO_TOTAL_COL=70
   export NL_NLAYER_TES_CO_PROFILE=70
   export NL_NLAYER_TES_CO_CPSR=70
   export NL_NLAYER_TES_CO2_TOTAL_COL=70
   export NL_NLAYER_TES_CO2_PROFILE=70
   export NL_NLAYER_TES_CO2_CPSR=70
   export NL_NLAYER_TES_O3_TOTAL_COL=70
   export NL_NLAYER_TES_O3_PROFILE=70
   export NL_NLAYER_TES_O3_CPSR=70
   export NL_NLAYER_TES_NH3_TOTAL_COL=70
   export NL_NLAYER_TES_NH3_PROFILE=70
   export NL_NLAYER_TES_NH3_CPSR=70
   export NL_NLAYER_TES_CH4_TOTAL_COL=70
   export NL_NLAYER_TES_CH4_PROFILE=70
   export NL_NLAYER_TES_CH4_CPSR=70
