...
#
# SERIAL VERSION
#   ${JOB_CONTROL_SCRIPTS_DIR}/job_script_nasa_model.ksh ${JOBRND} ${GENERAL_JOB_CLASS} ${GENERAL_TIME_LIMIT} ${GENERAL_NODES} ${GENERAL_TASKS} perturb_chem_icbc_CORR_RT_MA.exe SERIAL ${ACCOUNT} ${GENERAL_MODEL}
#
# PARALLEL VERSION
...
#
   mpiexec -np ${NPROC} ./perturb_chem_icbc_CORR_RT_MA_MPI.exe > index.html 2>&1
#
   let MEM=1
   while [[ ${MEM} -le ${NUM_MEMBERS} ]]; do
      export CMEM=e${MEM}
