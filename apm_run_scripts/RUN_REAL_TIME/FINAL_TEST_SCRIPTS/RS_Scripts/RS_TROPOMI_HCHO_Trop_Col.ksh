...
#
# DO THINNING
      cp ${DART_DIR}/observations/obs_converters/ATMOS_CHEM/TROPOMI_HCHO/work/tropomi_hcho_trop_thinner ./.
      ./tropomi_hcho_trop_col_thinner > index_thinner.html 2>&1
#
# GET EXECUTABLE
      cp ${DART_DIR}/observations/obs_converters/ATMOS_CHEM/TROPOMI_HCHO/work/tropomi_hcho_trop_col_ascii_to_obs ./.
      ./tropomi_hcho_trop_col_ascii_to_obs > index_ascii.html 2>&1
#
...
# Clean directory
      ...
      rm readme.* requiredMCRP* run_tropomi_hcho_* unresolved* tropomi_hcho_*
