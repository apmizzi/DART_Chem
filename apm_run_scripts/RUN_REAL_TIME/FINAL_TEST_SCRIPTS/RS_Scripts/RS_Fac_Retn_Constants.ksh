...
export NNL_MOPITT_CO_RETEN_FREQ=1
export NL_MODIS_AOD_RETEN_FREQ=1
export NL_IASI_CO_RETEN_FREQ=1
export NL_IASI_O3_RETEN_FREQ=1
export NL_MODIS_AOD_RETEN_FREQ=1
export NNL_OMI_O3_RETEN_FREQ=1
export NNL_OMI_NO2_RETEN_FREQ=1
export NNL_OMI_NO2_DOMINO_RETEN_FREQ=1
export NNL_OMI_SO2_RETEN_FREQ=1
export NNL_OMI_HCHO_RETEN_FREQ=1
...
export NNL_TES_CO_RETEN_FREQ=1
export NNL_TES_CO2_RETEN_FREQ=1
export NNL_TES_O3_RETEN_FREQ=1
export NNL_TES_NH3_RETEN_FREQ=1
export NNL_TES_CH4_RETEN_FREQ=1
...
export NNL_SCIAM_NO2_RETEN_FREQ=1
export NNL_GOME2A_NO2_RETEN_FREQ=1
export NNL_MLS_O3_RETEN_FREQ=1
export NNL_MLS_HNO3_RETEN_FREQ=1
export NNL_AIRNOW_CO_RETEN_FREQ=1
export NNL_AIRNOW_O3_RETEN_FREQ=1
export NNL_AIRNOW_NO2_RETEN_FREQ=1
export NNL_AIRNOW_SO2_RETEN_FREQ=1
export NNL_AIRNOW_PM10_RETEN_FREQ=1
export NNL_AIRNOW_PM25_RETEN_FREQ=1
