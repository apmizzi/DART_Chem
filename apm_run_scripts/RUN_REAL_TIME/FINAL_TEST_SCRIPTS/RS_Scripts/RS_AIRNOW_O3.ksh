...
#
      ...
      rm -rf \${INFILE}
      cp ${EXPERIMENT_AIRNOW_DIR}/airnow_o3_hourly_csv_data/\${BIN_BEG_YR}/\${INFILE} ./.
#
...
#
# Clean directory
#      rm -rf airnow_o3_* bias_correct* create_airnow* dart_log* input.nml      
EOF
