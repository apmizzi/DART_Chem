...
#
# COPY EXECUTABLE
      rm -rf mls_o3_profile_extract.m
      cp ${DART_DIR}/observations/obs_converters/ATMOS_CHEM/MLS_O3/native_to_ascii/mls_o3_profile_extract.m ./.
      rm -rf mls_o3_profile_extract
      cp ${DART_DIR}/observations/obs_converters/ATMOS_CHEM/MLS_O3/native_to_ascii/work/mls_o3_profile_extract ./.
      rm -rf run_mls_o3_profile_extract.sh
      cp ${DART_DIR}/observations/obs_converters/ATMOS_CHEM/MLS_O3/native_to_ascii/work/run_mls_o3_profile_extract.sh ./.
#
      export HOME=/tmp
