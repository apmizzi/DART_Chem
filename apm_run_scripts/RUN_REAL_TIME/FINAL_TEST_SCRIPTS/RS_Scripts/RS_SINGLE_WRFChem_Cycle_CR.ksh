...
#
# PARALLEL
#        ${JOB_CONTROL_SCRIPTS_DIR}/job_script_nasa_model.ksh ${JOBRND} ${WRFCHEM_JOB_CLASS} ${WRFCHEM_TIME_LIMIT} ${WRFCHEM_NODES} ${WRFCHEM_TASKS} wrf.exe PARALLEL ${ACCOUNT} ${WRFCHEM_MODEL} ${WRFCHEM_MODEL}
#
...
#	 fi    
#
         mpiexec -np ${NPROC} ./wrf.exe > index.html 2>&1
#
         let IMEM=${IMEM}+1
      done
#
