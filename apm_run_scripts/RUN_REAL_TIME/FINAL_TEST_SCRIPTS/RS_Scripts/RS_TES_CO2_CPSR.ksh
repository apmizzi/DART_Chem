...
#
# DO THINNING
      cp ${DART_DIR}/observations/obs_converters/ATMOS_CHEM/TES_CO2/work/tes_co2_cpsr_thinner ./.
      ./tes_co2_cpsr_thinner > index_thinner.html 2>&1
#
# GET EXECUTABLE
      cp ${DART_DIR}/observations/obs_converters/ATMOS_CHEM/TES_CO2/work/tes_co2_cpsr_ascii_to_obs ./.
      ./tes_co2_cpsr_ascii_to_obs > index_ascii.html 2>&1
#
