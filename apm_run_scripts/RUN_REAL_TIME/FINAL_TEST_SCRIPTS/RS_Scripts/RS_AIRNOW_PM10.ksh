...
#
      export INFILE=airnow_pm10_hourly_csv_data
      rm -rf ${INFILE}
      cp ${EXPERIMENT_AIRNOW_DIR}/airnow_pm10_hourly_csv_data/${BIN_BEG_YR}/${INFILE} ./.
#
...
#
# Clean directory
      rm -rf airnow_pm10_* bias_correct* create_airnow* dart_log* input.nml      
