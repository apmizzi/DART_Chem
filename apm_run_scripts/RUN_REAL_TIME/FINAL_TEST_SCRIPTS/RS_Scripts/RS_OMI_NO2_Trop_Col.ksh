...
# DO THINNING
      ...
      ./omi_no2_trop_col_thinner > index_thinner.html 2>&1
#
# GET EXECUTABLE
      cp ${DART_DIR}/observations/obs_converters/ATMOS_CHEM/OMI_NO2/work/omi_no2_trop_col_ascii_to_obs ./.
      ./omi_no2_trop_col_ascii_to_obs > index_ascii.html 2>&1
#
...
#
# Clean directory
      rm dart_log* includedSupport* input.nml mccExcluded* *.dat omi_no2_trop*
