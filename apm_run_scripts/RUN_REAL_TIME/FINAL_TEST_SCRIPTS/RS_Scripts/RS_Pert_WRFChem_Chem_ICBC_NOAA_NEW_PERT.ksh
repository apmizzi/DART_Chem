...
# PERTURB CHEM ICBC
   ...
   export NL_SW_BDY_ONLY=true
   if [[ ${DATE} -eq ${INITIAL_DATE} ]]; then export NL_SW_BDY_ONLY=false; fi
...
wrfinput_file_new='${WRFINPUT_FLD_RW}',
wrfbdy_file_new='${WRFBDY_FLD_RW}',
