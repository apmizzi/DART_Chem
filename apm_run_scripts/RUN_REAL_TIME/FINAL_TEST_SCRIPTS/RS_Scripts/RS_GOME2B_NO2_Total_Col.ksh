...
# SET GOME2B PARAMETERS
      ...
      export GOME2B_FILE_PRE=GOME2B_NO2_L2_V01_
      export GOME2B_FILE_EXT=.nc
...
# SET GOME2B INPUT DATA DIR
      export TMP_INFILE=\'${EXPERIMENT_GOME2B_NO2_DIR}/${YYYY}${MM}/${DD}/${GOME2B_FILE_PRE}${YYYY}${MM}${DD}T\'
#
# COPY EXECUTABLE
      export FILE=gome2b_no2_total_col_extract.m
      rm -rf ${FILE}
      cp ${DART_DIR}/observations/obs_converters/ATMOS_CHEM/GOME2B_NO2/native_to_ascii/${FILE} ./.
      mcc -m gome2b_no2_total_col_extract.m -o gome2b_no2_total_col_extract
      ./run_gome2b_no2_total_col_extract.sh ${MATLAB} ${TMP_INFILE} ${OUTFILE} ${GOME2B_FILE_PRE} ${BIN_BEG_YY} ${BIN_BEG_MM} ${BIN_BEG_DD} ${BIN_BEG_HH} ${BIN_BEG_MN} ${BIN_BEG_SS} ${BIN_END_YY} ${BIN_END_MM} ${BIN_END_DD} ${BIN_END_HH} ${BIN_END_MN} ${BIN_END_SS} ${NL_PATH_MODEL} ${NL_FILE_MODEL} ${NL_NX_MODEL} ${NL_NY_MODEL} > index_mat1.html 2>&1
#
...
# END OF PREVIOUS DAY (hours 21 to 24 obs)
      if [[ ${FLG} -eq 1 ]]; then	 
         ...
         export BIN_END_MN=59
         export BIN_END_SS=59
         export TMP_INFILE=\'${EXPERIMENT_GOME2B_NO2_DIR}/${GOME2B_FILE_PRE}${ASIM_MN_YYYY}${ASIM_MN_MM}${ASIM_MN_DD}T\'
#
# COPY EXECUTABLE
         export FILE=gome2b_no2_total_col_extract.m
         rm -rf ${FILE}
         cp ${DART_DIR}/observations/obs_converters/ATMOS_CHEM/GOME2B_NO2/native_to_ascii/${FILE} ./.
         mcc -m gome2b_no2_total_col_extract.m -o gome2b_no2_total_col_extract
         ./run_gome2b_no2_total_col_extract.sh ${MATLAB} ${TMP_INFILE} ${OUTFILE} ${GOME2B_FILE_PRE} ${BIN_BEG_YY} ${BIN_BEG_MM} ${BIN_BEG_DD} ${BIN_BEG_HH} ${BIN_BEG_MN} ${BIN_BEG_SS} ${BIN_END_YY} ${BIN_END_MM} ${BIN_END_DD} ${BIN_END_HH} ${BIN_END_MN} ${BIN_END_SS} ${NL_PATH_MODEL} ${NL_FILE_MODEL} ${NL_NX_MODEL} ${NL_NY_MODEL} > index_mat2.html 2>&1
#
      fi
#
# CHECK IF OUTFILE EXISTS AND ATTACH TO ARCHIVE FILE
...
# SET NAMELIST TO CONVERT GOME2B NO2 ASCII TO OBS_SEQ 
      ...
      export NL_FILEOUT=\'obs_seq_gome2b_no2_total_col_${DATE}.out\'
...
#
# GET EXECUTABLE
      cp ${DART_DIR}/observations/obs_converters/ATMOS_CHEM/GOME2B_NO2/work/gome2b_no2_total_col_ascii_to_obs ./.
      ./gome2b_no2_total_col_ascii_to_obs > index.html 2>&1
#
...
# Clean directory
      ...
      rm requiredMCRP* run_gome2b_no2* gome2b_no2_total* unresolved* *.dat
