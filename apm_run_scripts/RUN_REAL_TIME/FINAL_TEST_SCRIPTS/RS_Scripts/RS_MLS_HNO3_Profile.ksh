...
#
# COPY EXECUTABLE
      rm -rf mls_hno3_profile_extract.m
      cp ${DART_DIR}/observations/obs_converters/ATMOS_CHEM/MLS_HNO3/native_to_ascii/mls_hno3_profile_extract.m ./.
      rm -rf mls_hno3_profile_extract
      cp ${DART_DIR}/observations/obs_converters/ATMOS_CHEM/MLS_HNO3/native_to_ascii/work/mls_hno3_profile_extract ./.
      rm -rf run_mls_hno3_profile_extract.sh
      cp ${DART_DIR}/observations/obs_converters/ATMOS_CHEM/MLS_HNO3/native_to_ascii/work/run_mls_hno3_profile_extract.sh ./.
#
      export HOME=/tmp
...
# SET NAMELIST TO CONVERT MLS HNO3 ASCII TO OBS_SEQ 
      ...
      export NL_MLS_O3_RETEN_FREQ=${NNL_MLS_O3_RETEN_FREQ}
      export NL_MLS_HNO3_RETEN_FREQ=${NNL_MLS_HNO3_RETEN_FREQ}
#
