...
#
# DO THINNING
      cp ${DART_DIR}/observations/obs_converters/ATMOS_CHEM/TEMPO_O3/work/tempo_o3_profile_thinner ./.
      ./tempo_o3_profile_thinner > index_thinner.html 2>&1
#
# GET EXECUTABLE
      cp ${DART_DIR}/observations/obs_converters/ATMOS_CHEM/TEMPO_O3/work/tempo_o3_profile_ascii_to_obs ./.
      ./tempo_o3_profile_ascii_to_obs > index_ascii.html 2>&1
#
