...
# SET MOPITT PARAMETERS
      ...
      export MOPITT_FILE_EXT=-L2V19.*he5 
...
# USE MOPITT DATA 
      rm -rf input.nml
      ${NAMELIST_SCRIPTS_DIR}/OBS_CONVERTERS/da_create_dart_mopitt_v9_input_nml.ksh
#
# DO THINNING
      cp ${DART_DIR}/observations/obs_converters/ATMOS_CHEM/MOPITT_CO/work/mopitt_v9_co_profile_thinner ./.
      ./mopitt_v9_co_profile_thinner > index_thinner.html 2>&1
#
# GET EXECUTABLE
      cp ${DART_DIR}/observations/obs_converters/ATMOS_CHEM/MOPITT_CO/work/mopitt_v9_co_profile_ascii_to_obs ./.
      ./mopitt_v9_co_profile_ascii_to_obs > index_ascii.html 2>&1
#
...
#
# Clean directory
#      rm dart_log* includedSupport* input.nml mccExcluded* *.dat mopitt_v9_co_profile*
#      rm readme.* requiredMCRP* run_mopitt_v9_co_profile_* includeSupport* unresolved*
EOF
