...
#
# DO THINNING
      cp ${DART_DIR}/observations/obs_converters/ATMOS_CHEM/TES_O3/work/tes_o3_cpsr_thinner ./.
      ./tes_o3_cpsr_thinner > index_thinner.html 2>&1
#
# GET EXECUTABLE
      cp ${DART_DIR}/observations/obs_converters/ATMOS_CHEM/TES_O3/work/tes_o3_cpsr_ascii_to_obs ./.
      ./tes_o3_cpsr_ascii_to_obs > index_ascii.html 2>&1
#
