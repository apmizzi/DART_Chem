...
#
   ...
   export DEBUG_TASKS=128
   export DEBUG_MODEL=mil_ait
   export DEBUG_MODEL=rom_ait
#
...
#
   ...
   export BIO_NODES=1
   export BIO_TASKS=128
   export BIO_MODEL=mil_ait
   export BIO_MODEL=rom_ait
#
...
#
   ...
   export WRFCHEM_SING_NODES=1
   export WRFCHEM_SING_TASKS=128
   export WRFCHEM_SING_MODEL=mil_ait
   export WRFCHEM_SING_MODEL=rom_ait
#
   export PERT_JOB_CLASS=normal
   export PERT_TIME_LIMIT=05:59:00
   export PERT_NODES=1
   export PERT_TASKS=128
   export PERT_MODEL=mil_ait
   export PERT_MODEL=rom_ait
