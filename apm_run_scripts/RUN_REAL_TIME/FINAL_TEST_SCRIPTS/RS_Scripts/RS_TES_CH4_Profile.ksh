...
#
# DO THINNING
      cp ${DART_DIR}/observations/obs_converters/ATMOS_CHEM/TES_CH4/work/tes_ch4_profile_thinner ./.
      ./tes_ch4_profile_thinner > index_thinner.html 2>&1
#
# GET EXECUTABLE
      cp ${DART_DIR}/observations/obs_converters/ATMOS_CHEM/TES_CH4/work/tes_ch4_profile_ascii_to_obs ./.
      ./tes_ch4_profile_ascii_to_obs > index_ascii.html 2>&1
#
