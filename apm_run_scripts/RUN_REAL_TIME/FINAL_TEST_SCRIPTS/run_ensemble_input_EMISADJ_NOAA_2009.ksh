...
#
export RUN_DIR=${EXPERIMENT_DIR}/INPUT_DATA_EMISADJ_NOAA_2009
export RUN_INPUT_DIR=${EXPERIMENT_DIR}/INPUT_DATA_EMISADJ_NOAA_2009
...
if [[ ${RUN_SPECIAL_PERT_DATE} = "true" ]]; then
   export SPECIAL_PERT_DATE=2009040206
fi
#
