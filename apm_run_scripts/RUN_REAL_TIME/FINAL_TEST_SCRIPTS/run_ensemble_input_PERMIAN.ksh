...
#
   ...
   source ${RS_SCRIPTS_DIR}/RS_Forecast_Time_Domain_Params_PERMIAN.ksh > index_RS_Forecast_Time_Domain_Params_${DATE} 2>&1
   rm -rf index_RS_WRFChem_Namelists_${DATE}
   source ${RS_SCRIPTS_DIR}/RS_WRFChem_Namelists_PERMIAN.ksh > index_RS_WRFChem_Namelists_${DATE} 2>&1
