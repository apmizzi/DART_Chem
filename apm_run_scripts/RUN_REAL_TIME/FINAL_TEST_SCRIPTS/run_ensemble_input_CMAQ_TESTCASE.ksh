...
# and observations for running CMAQ/DART
#
#########################################################################
#
# ROOT DIRECTORIES:
...
export RUN_DIR=${EXPERIMENT_DIR}/INPUT_DATA_CMAQ_TESTCASE
...
export CMAQ_TEMPLATE_FILE=cmaqout_d01_2018-07-01:00:00:00
...
#
   if ${RUN_MOPITT_CO_PROFILE_OBS}; then
      ...
      source ${RS_SCRIPTS_DIR}/RS_MOPITT_CO_Profile_CMAQ.ksh > index_rs.html 2>&1
   fi
#
########################################################################
#
...
#
   if ${RUN_MOPITT_CO_CPSR_OBS}; then
      ...
      source ${RS_SCRIPTS_DIR}/RS_MOPITT_CO_CPSR_CMAQ.ksh > index_rs.html 2>&1
   fi
#
#########################################################################
#
