...
#
export RUN_DIR=${EXPERIMENT_DIR}/INPUT_DATA_NOAA_2021
export RUN_INPUT_DIR=${EXPERIMENT_DIR}/INPUT_DATA_NOAA_2021
...
#
# END CYCLE DATE-TIME:
export CYCLE_END_DATE=2021040200
#
...
#   export WRFCHEM_VER=WRFCHEMv4.3.2_dmparr
   ...
   export NL_FIRE_FILE=GLOBAL_FINNv15_2021_MOZ4.txt
