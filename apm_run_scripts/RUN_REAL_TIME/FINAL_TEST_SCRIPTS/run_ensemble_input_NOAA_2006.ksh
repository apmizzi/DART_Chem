...
#
export RUN_DIR=${EXPERIMENT_DIR}/INPUT_DATA_NOAA_2006
...
export CYCLE_STR_DATE=2006040218
#
# END CYCLE DATE-TIME:
export CYCLE_END_DATE=2006040218
#
...
if [[ ${RUN_SPECIAL_PERT_DATE} = "true" ]]; then
   export SPECIAL_PERT_DATE=200604020300
fi
#    
...
#
# Leave these as true for TRACER-I   
