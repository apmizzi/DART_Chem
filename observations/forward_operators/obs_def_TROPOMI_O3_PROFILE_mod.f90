...
! TROPOMI_O3_PROFILE, QTY_O3
! END DART PREPROCESS TYPE DEFINITIONS
!
! BEGIN DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!   use obs_def_tropomi_o3_profile_mod, only : get_expected_tropomi_o3_profile, &
!                                  read_tropomi_o3_profile, &
!                                  write_tropomi_o3_profile, &
!                                  interactive_tropomi_o3_profile
! END DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!
! BEGIN DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!      case(TROPOMI_O3_PROFILE)                                                           
!         call get_expected_tropomi_o3_profile(state_handle, ens_size, location, obs_def%key, obs_time, expected_obs, istatus)  
! END DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!
! BEGIN DART PREPROCESS READ_OBS_DEF
!      case(TROPOMI_O3_PROFILE)
!         call read_tropomi_o3_profile(obs_def%key, ifile, fileformat)
! END DART PREPROCESS READ_OBS_DEF
!
! BEGIN DART PREPROCESS WRITE_OBS_DEF
!      case(TROPOMI_O3_PROFILE)
!         call write_tropomi_o3_profile(obs_def%key, ifile, fileformat)
! END DART PREPROCESS WRITE_OBS_DEF
!
! BEGIN DART PREPROCESS INTERACTIVE_OBS_DEF
!      case(TROPOMI_O3_PROFILE)
!         call interactive_tropomi_o3_profile(obs_def%key)
! END DART PREPROCESS INTERACTIVE_OBS_DEF
!
! BEGIN DART PREPROCESS MODULE CODE

module obs_def_tropomi_o3_profile_mod
...
! set_time sets time_type from julian day and seconds
   ...
   public :: write_tropomi_o3_profile, &
          read_tropomi_o3_profile, &
          interactive_tropomi_o3_profile, &
          get_expected_tropomi_o3_profile, &
          set_obs_def_tropomi_o3_profile
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter :: source   = 'obs_def_tropomi_o3_profile_mod.f90'
...
subroutine read_tropomi_o3_profile(key, ifile, fform)
...
! Need to know how many layers for this one
   ...
   if(counts1 > max_tropomi_o3_obs) then
      write(string1, *)'Not enough space for tropomi o3 profile obs.'
      write(string2, *)'Can only have max_tropomi_o3_obs (currently ',max_tropomi_o3_obs,')'
      call error_handler(E_ERR,'read_tropomi_o3_profile',string1,source,text2=string2)
   endif
   
   call set_obs_def_tropomi_o3_profile(key, pressure_1, avg_kernel_1,prior_1, nlayer_1, kend_1)
   
   deallocate(pressure_1, avg_kernel_1, prior_1)

end subroutine read_tropomi_o3_profile

!-------------------------------------------------------------------------------

subroutine write_tropomi_o3_profile(key, ifile, fform)
...
end subroutine write_tropomi_o3_profile

!-------------------------------------------------------------------------------

subroutine interactive_tropomi_o3_profile(key)
...
! STOP because routine is not finished.
   write(string1,*)'interactive_tropomi_o3_profile not yet working.'
   call error_handler(E_ERR, 'interactive_tropomi_o3_profile', string1, source)
   
   if(num_tropomi_o3_obs >= max_tropomi_o3_obs) then
      write(string1, *)'Not enough space for an tropomi o3 profileobs.'
      write(string2, *)'Can only have max_tropomi_o3_obs (currently ',max_tropomi_o3_obs,')'
      call error_handler(E_ERR, 'interactive_tropomi_o3_profile', string1, &
...
! Otherwise, prompt for input for the three required beasts
   ...
   write(*, *) 'Creating an interactive_tropomi_o3 profile observation'
   write(*, *) 'This featue is not setup '

end subroutine interactive_tropomi_o3_profile

!-------------------------------------------------------------------------------

subroutine get_expected_tropomi_o3_profile(state_handle, ens_size, location, key, obs_time, expct_val, istatus)
   ...
   character(len=*), parameter :: routine = 'get_expected_tropomi_o3_profile'
...
end subroutine get_expected_tropomi_o3_profile

!-------------------------------------------------------------------------------

subroutine set_obs_def_tropomi_o3_profile(key, o3_pressure, o3_avg_kernel, o3_prior, o3_nlayer, o3_kend)
   ...
   if(num_tropomi_o3_obs >= max_tropomi_o3_obs) then
      write(string1, *)'Not enough space for tropomi o3 profile obs.'
      write(string2, *)'Can only have max_tropomi_o3_obs (currently ',max_tropomi_o3_obs,')'
      call error_handler(E_ERR,'set_obs_def_tropomi_o3_profile',string1,source,revision, &
...
end subroutine set_obs_def_tropomi_o3_profile

end module obs_def_tropomi_o3_profile_mod
