...
! IASI_O3_PROFILE, QTY_O3
! END DART PREPROCESS KIND LIST

! BEGIN DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!   use obs_def_IASI_O3_PROFILE_mod, only : write_iasi_o3_profile, read_iasi_o3_profile, &
!                                   interactive_iasi_o3_profile, get_expected_iasi_o3_profile, &
!                                   set_obs_def_iasi_o3_profile
! END DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE

! BEGIN DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!      case(IASI_O3_PROFILE)                                                           
!          call get_expected_iasi_o3_profile(state_handle, ens_size, location, obs_def%key, expected_obs, istatus)  
! END DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF

! BEGIN DART PREPROCESS READ_OBS_DEF
!      case(IASI_O3_PROFILE)
!         call read_iasi_o3_profile(obs_def%key, ifile, fileformat)
! END DART PREPROCESS READ_OBS_DEF

! BEGIN DART PREPROCESS WRITE_OBS_DEF
!      case(IASI_O3_PROFILE)
!         call write_iasi_o3_profile(obs_def%key, ifile, fileformat)
! END DART PREPROCESS WRITE_OBS_DEF

! BEGIN DART PREPROCESS INTERACTIVE_OBS_DEF
!      case(IASI_O3_PROFILE)
!         call interactive_iasi_o3_profile(obs_def%key)
! END DART PREPROCESS INTERACTIVE_OBS_DEF
!
! BEGIN DART PREPROCESS SET_OBS_DEF_IASI_O3_PROFILE
!      case(IASI_O3_PROFILE)
!         call set_obs_def_iasi_o3_profile(obs_def%key)
!         call set_obs_def_iasi_o3_profile(key, avg_kernel, pressure, iasi_prior_trm, &
!         iasi_psf, iasi_altitude, iasi_air_column, iasi_prior, iasi_nlevels)
!
! END DART PREPROCESS SET_OBS_DEF_IASI_O3_PROFILE
!
! BEGIN DART PREPROCESS MODULE CODE
module obs_def_IASI_O3_PROFILE_mod
...
public :: write_iasi_o3_profile,        &
          read_iasi_o3_profile,         &
          interactive_iasi_o3_profile,  &
          get_expected_iasi_o3_profile, &
          set_obs_def_iasi_o3_profile
...
character(len=*), parameter :: source   = 'obs_def_IASI_O3_PROFILE_mod.f90'
...
namelist /obs_def_IASI_O3_nml/ IASI_O3_retrieval_type, use_log_o3, nlayer_model, &
nlayer_iasi_o3_profile
...
subroutine read_iasi_o3_profile(key, ifile, fform)
...
counts1 = counts1 + 1
key = counts1
call set_obs_def_iasi_o3_profile(key, avg_kernel_1, pressure_1, iasi_prior_trm_1, &
   iasi_psurf_1, iasi_altitude_1, iasi_air_column_1, iasi_prior_1, iasi_nlevels_1)

end subroutine read_iasi_o3_profile

!----------------------------------------------------------------------

subroutine write_iasi_o3_profile(key, ifile, fform)
...
SELECT CASE (fileformat)
   ...
   write(ifile, *) key
END SELECT 
end subroutine write_iasi_o3_profile
!
subroutine interactive_iasi_o3_profile(key)
!----------------------------------------------------------------------
! subroutine interactive_iasi_o3_profile(key)
!
...
if(num_iasi_o3_obs >= MAX_IASI_O3_OBS) then
   ...
   call error_handler(E_ERR,'interactive_iasi_o3_profile',string1,source,revision,revdate,text2=string2)
endif
!
! Increment the index
...
write(*, *) 'Creating an interactive_iasi_o3_profile observation'
...
end subroutine interactive_iasi_o3_profile
!
!----------------------------------------------------------------------
!
subroutine get_expected_iasi_o3_profile(state_handle, ens_size, location, key, val, istatus)
!----------------------------------------------------------------------
!subroutine get_expected_iasi_o3_profile(state, location, key, val, istatus)
...
!
   ...
   character(len=*), parameter :: routine = 'get_expected_iasi_o3_profile'
...
! WRF surface pressure
   ...
   if(any(sfcp_istatus/=0)) then
      ...
      call error_handler(E_MSG,'set_obs_def_iasi_o3_profile',string1,source,revision,revdate)
   endif
...
!
end subroutine get_expected_iasi_o3_profile
!
!----------------------------------------------------------------------

subroutine set_obs_def_iasi_o3_profile(key, o3_avgker, o3_press, o3_prior_trm, o3_psurf, o3_altitude, &
...
if(num_iasi_o3_obs >= MAX_IASI_O3_OBS) then
   write(string1, *)'Not enough space for a iasi O3 obs.'
   write(string2, *)'Can only have MAX_IASI_O3_OBS (currently ',MAX_IASI_O3_OBS,')'
   call error_handler(E_ERR,'set_obs_def_iasi_o3_profile',string1,source,revision,revdate,text2=string2)
endif
...
end subroutine set_obs_def_iasi_o3_profile
...
!
end module obs_def_IASI_O3_PROFILE_mod
