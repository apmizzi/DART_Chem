...
! TROPOMI_O3_TOTAL_COL, QTY_O3
! END DART PREPROCESS TYPE DEFINITIONS
!
! BEGIN DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!   use obs_def_tropomi_o3_total_col_mod, only : get_expected_tropomi_o3_total_col, &
!                                  read_tropomi_o3_total_col, &
!                                  write_tropomi_o3_total_col, &
!                                  interactive_tropomi_o3_total_col
! END DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!
! BEGIN DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!      case(TROPOMI_O3_TOTAL_COL)                                                           
!         call get_expected_tropomi_o3_total_col(state_handle, ens_size, location, obs_def%key, obs_time, expected_obs, istatus)  
! END DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!
! BEGIN DART PREPROCESS READ_OBS_DEF
!      case(TROPOMI_O3_TOTAL_COL)
!         call read_tropomi_o3_total_col(obs_def%key, ifile, fileformat)
! END DART PREPROCESS READ_OBS_DEF
!
! BEGIN DART PREPROCESS WRITE_OBS_DEF
!      case(TROPOMI_O3_TOTAL_COL)
!         call write_tropomi_o3_total_col(obs_def%key, ifile, fileformat)
! END DART PREPROCESS WRITE_OBS_DEF
!
! BEGIN DART PREPROCESS INTERACTIVE_OBS_DEF
!      case(TROPOMI_O3_TOTAL_COL)
!         call interactive_tropomi_o3_total_col(obs_def%key)
! END DART PREPROCESS INTERACTIVE_OBS_DEF
!
! BEGIN DART PREPROCESS MODULE CODE

module obs_def_tropomi_o3_total_col_mod
...
! set_time sets time_type from julian day and seconds
   ...
   public :: write_tropomi_o3_total_col, &
          read_tropomi_o3_total_col, &
          interactive_tropomi_o3_total_col, &
          get_expected_tropomi_o3_total_col, &
          set_obs_def_tropomi_o3_total_col
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter :: source   = 'obs_def_tropomi_o3_total_col_mod.f90'
...
! Record the namelist values
   ...
   nlayer_tropomi=nlayer_tropomi_o3_total_col
...
subroutine read_tropomi_o3_total_col(key, ifile, fform)
...
! Need to know how many layers for this one
   ...
   if(counts1 > max_tropomi_o3_obs) then
      ...
      call error_handler(E_ERR,'read_tropomi_o3_total_col',string1,source,text2=string2)
   endif
   
   call set_obs_def_tropomi_o3_total_col(key, pressure_1, avg_kernel_1,prior_1, nlayer_1, kend_1)
   
   deallocate(pressure_1, avg_kernel_1, prior_1)

end subroutine read_tropomi_o3_total_col

!-------------------------------------------------------------------------------

subroutine write_tropomi_o3_total_col(key, ifile, fform)
...
end subroutine write_tropomi_o3_total_col

!-------------------------------------------------------------------------------

subroutine interactive_tropomi_o3_total_col(key)
...
! STOP because routine is not finished.
   ...
   call error_handler(E_ERR, 'interactive_tropomi_o3_total_col', string1, source)
   
   if(num_tropomi_o3_obs >= max_tropomi_o3_obs) then
      write(string1, *)'Not enough space for an tropomi o3 obs.'
      write(string2, *)'Can only have max_tropomi_o3_obs (currently ',max_tropomi_o3_obs,')'
      call error_handler(E_ERR, 'interactive_tropomi_o3_total_col', string1, &
...
! Otherwise, prompt for input for the three required beasts
   ...
   write(*, *) 'Creating an interactive_tropomi_o3_total_col observation'
   write(*, *) 'This featue is not setup '

end subroutine interactive_tropomi_o3_total_col

!-------------------------------------------------------------------------------

subroutine get_expected_tropomi_o3_total_col(state_handle, ens_size, location, key, obs_time, expct_val, istatus)
   ...
   character(len=*), parameter :: routine = 'get_expected_tropomi_o3_total_col'
...
end subroutine get_expected_tropomi_o3_total_col

!-------------------------------------------------------------------------------

subroutine set_obs_def_tropomi_o3_total_col(key, o3_pressure, o3_avg_kernel, o3_prior, o3_nlayer, o3_kend)
...
end subroutine set_obs_def_tropomi_o3_total_col

end module obs_def_tropomi_o3_total_col_mod
