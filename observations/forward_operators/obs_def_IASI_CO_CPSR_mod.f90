...
!   use obs_def_IASI_CO_CPSR_mod, only : write_iasi_co_cpsr, read_iasi_co_cpsr, &
                                    interactive_iasi_co_cpsr, get_expected_iasi_co_cpsr, &
                                    set_obs_def_iasi_co_cpsr
! END DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE

! BEGIN DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!      case(IASI_CO_CPSR)                                                           
!          call get_expected_iasi_co_cpsr(state_handle, ens_size, location, obs_def%key, expected_obs, istatus)  
! END DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF

! BEGIN DART PREPROCESS READ_OBS_DEF
!      case(IASI_CO_CPSR)
!          call read_iasi_co_cpsr(obs_def%key, ifile, fileformat)
! END DART PREPROCESS READ_OBS_DEF

! BEGIN DART PREPROCESS WRITE_OBS_DEF
!      case(IASI_CO_CPSR)
!          call write_iasi_co_cpsr(obs_def%key, ifile, fileformat)
! END DART PREPROCESS WRITE_OBS_DEF

! BEGIN DART PREPROCESS INTERACTIVE_OBS_DEF
!      case(IASI_CO_CPSR)
!          call interactive_iasi_co_cpsr(obs_def%key)
! END DART PREPROCESS INTERACTIVE_OBS_DEF
!
! BEGIN DART PREPROCESS SET_OBS_DEF_IASI_CO_CPSR
!      case(IASI_CO_CPSR)
!          call set_obs_def_iasi_co_cpsr(obs_def%key)
! END DART PREPROCESS SET_OBS_DEF_IASI_CO_CPSR
!
! BEGIN DART PREPROCESS MODULE CODE
module obs_def_IASI_CO_CPSR_mod
   ...
   public :: write_iasi_co_cpsr, &
          read_iasi_co_cpsr, &
          interactive_iasi_co_cpsr, &
          get_expected_iasi_co_cpsr, &
          set_obs_def_iasi_co_cpsr
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter :: source   = 'obs_def_IASI_CO_CPSR_mod.f90'
...
!     CPSR - compact phase space retrievals
   namelist /obs_def_IASI_CO_nml/ IASI_CO_retrieval_type, use_log_co, nlayer_model, &
   nlayer_iasi_co_total_col, nlayer_iasi_co_profile
...
!
subroutine read_iasi_co_cpsr(key, ifile, fform)
!----------------------------------------------------------------------
!subroutine read_iasi_co_cpsr(key, ifile, fform)
...
counts1 = counts1 + 1
key = counts1
call set_obs_def_iasi_co_cpsr(key, avg_kernels_1, pressure_1, iasi_prior_1, iasi_psurf_1, &
                           iasi_nlayers_1, iasi_nlevels_1)
end subroutine read_iasi_co_cpsr
!
subroutine write_iasi_co_cpsr(key, ifile, fform)
!----------------------------------------------------------------------
!subroutine write_iasi_co_cpsr(key, ifile, fform)
...
SELECT CASE (fileformat)
   ...
   write(ifile, *) key
END SELECT 
end subroutine write_iasi_co_cpsr
!
subroutine interactive_iasi_co_cpsr(key)
!----------------------------------------------------------------------
!subroutine interactive_iasi_co_cpsr(key)
!
...
if(num_iasi_co_obs >= MAX_IASI_CO_OBS) then
   ...
   call error_handler(E_ERR,'interactive_iasi_co_cpsr',string1,source,revision,revdate,text2=string2)
endif
!
! Increment the index
...
write(*, *) 'Creating an interactive_iasi_co_cpsr observation'
...
end subroutine interactive_iasi_co_cpsr
!
subroutine get_expected_iasi_co_cpsr(state_handle, ens_size, location, key, val, istatus)
!----------------------------------------------------------------------
!subroutine get_expected_iasi_co_cpsr(state_handle, ens_size, location, key, val, istatus)
...
!
   ...
   character(len=*), parameter :: routine = 'get_expected_iasi_co_cpsr'
   logical :: return_now
!
! Initialize DART
   istatus(:) = 0
...
! Clean up and return
   ...
   deallocate(prs_iasi)
!
end subroutine get_expected_iasi_co_cpsr
!
subroutine set_obs_def_iasi_co_cpsr(key, co_avgker, co_press, co_prior, co_psurf, co_nlayers, co_nlevels)
!----------------------------------------------------------------------
! subroutine set_obs_def_iasi_co_cpsr(key, co_avgker, co_press, co_prior, co_psurf, co_nlayers, co_nlevels)
...
character(len=*), parameter :: routine = 'set_obs_def_iasi_co_cpsr'
...
end subroutine set_obs_def_iasi_co_cpsr
!
...
!----------------------------------------------------------------------
!
end module obs_def_IASI_CO_CPSR_mod
