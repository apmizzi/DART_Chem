...
! MOPITT_CO_PROFILE, QTY_CO
! END DART PREPROCESS TYPE DEFINITIONS

! BEGIN DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!   use obs_def_mopitt_co_profile_mod, only : write_mopitt_co_profile, read_mopitt_co_profile, &
!                                  interactive_mopitt_co_profile, get_expected_mopitt_co_profile, &
!                                  set_obs_def_mopitt_co_profile
! END DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE

! BEGIN DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!         case(MOPITT_CO_PROFILE)                                                           
!            call get_expected_mopitt_co_profile(state_handle, ens_size, location, obs_def%key, expected_obs, istatus)  
! END DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF

! BEGIN DART PREPROCESS READ_OBS_DEF
!      case(MOPITT_CO_PROFILE)
!         call read_mopitt_co_profile(obs_def%key, ifile, fileformat)
! END DART PREPROCESS READ_OBS_DEF

! BEGIN DART PREPROCESS WRITE_OBS_DEF
!      case(MOPITT_CO_PROFILE)
!         call write_mopitt_co_profile(obs_def%key, ifile, fileformat)
! END DART PREPROCESS WRITE_OBS_DEF

! BEGIN DART PREPROCESS INTERACTIVE_OBS_DEF
!      case(MOPITT_CO_PROFILE)
!         call interactive_mopitt_co_profile(obs_def%key)
! END DART PREPROCESS INTERACTIVE_OBS_DEF

! BEGIN DART PREPROCESS SET_OBS_DEF_MOPITT_CO_PROFILE
!      case(MOPITT_CO_PROFILE)
!         call set_obs_def_mopitt_co_profile(obs_def%key)
! END DART PREPROCESS SET_OBS_DEF_MOPITT_CO_PROFILE

! BEGIN DART PREPROCESS MODULE CODE
module obs_def_mopitt_co_profile_mod
   ...
   public :: write_mopitt_co_profile, &
             read_mopitt_co_profile, &
             interactive_mopitt_co_profile, &
             get_expected_mopitt_co_profile, &
             set_obs_def_mopitt_co_profile
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter :: source   = 'obs_def_MOPITT_CO_PROFILE_mod.f90'
...
subroutine read_mopitt_co_profile(key, ifile, fform)
!----------------------------------------------------------------------
!subroutine read_mopitt_co_profile(key, ifile, fform)
...
counts1 = counts1 + 1
key = counts1
call set_obs_def_mopitt_co_profile(key, avg_kernels_1, mopitt_prior_1, &
     mopitt_psurf_1, mopitt_nlayers_1)

end subroutine read_mopitt_co_profile

 subroutine write_mopitt_co_profile(key, ifile, fform)
!----------------------------------------------------------------------
!subroutine write_mopitt_co_profile(key, ifile, fform)
...
SELECT CASE (fileformat)
   ...
   write(ifile, *) key
END SELECT 
end subroutine write_mopitt_co_profile
!
subroutine interactive_mopitt_co_profile(key)
!----------------------------------------------------------------------
!subroutine interactive_mopitt_co_profile(key)
!
...
if(num_mopitt_co_obs >= MAX_MOPITT_CO_OBS) then
   ...
   call error_handler(E_ERR,'interactive_mopitt_co_profile',string1,source,revision,revdate, text2=string2)
endif
...
write(*, *) 'Creating an interactive_mopitt_co_profile observation'
...
end subroutine interactive_mopitt_co_profile
!
subroutine get_expected_mopitt_co_profile(state_handle, ens_size, location, key, val, istatus)
!----------------------------------------------------------------------
!subroutine get_expected_mopitt_co_profile(state_handle, ens_size, location, key, val, istatus)
...
!
   ...
   character(len=*), parameter :: routine = 'get_expected_mopitt_co_profile'
   logical :: return_now
!
! Initialize DART
...
!
end subroutine get_expected_mopitt_co_profile
!
!----------------------------------------------------------------------

 subroutine set_obs_def_mopitt_co_profile(key, co_avgker, co_prior, co_psurf, co_nlayers)
!----------------------------------------------------------------------
...
if(num_mopitt_co_obs >= MAX_MOPITT_CO_OBS) then
   write(string1, *)'Not enough space for a mopitt CO obs.'
   call error_handler(E_MSG,'set_obs_def_mopitt_co_profile',string1,source,revision,revdate)
   write(string1, *)'Can only have MAX_MOPITT_CO_OBS (currently ',MAX_MOPITT_CO_OBS,')'
   call error_handler(E_ERR,'set_obs_def_mopitt_co_profile',string1,source,revision,revdate)
endif
...
end subroutine set_obs_def_mopitt_co_profile
...
end module obs_def_mopitt_co_profile_mod
