...
! OMI_NO2_DOMINO_TOTAL_COL, QTY_NO2
! END DART PREPROCESS TYPE DEFINITIONS
!
! BEGIN DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!   use obs_def_omi_no2_domino_total_col_mod, only : get_expected_omi_no2_domino_total_col, &
!                                   read_omi_no2_domino_total_col, &
!                                   write_omi_no2_domino_total_col, &
!                                   interactive_omi_no2_domino_total_col
! END DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!
! BEGIN DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!      case(OMI_NO2_DOMINO_TOTAL_COL)                                                           
!         call get_expected_omi_no2_domino_total_col(state_handle, ens_size, location, obs_def%key, expected_obs, istatus)  
! END DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!
! BEGIN DART PREPROCESS READ_OBS_DEF
!      case(OMI_NO2_DOMINO_TOTAL_COL)
!         call read_omi_no2_domino_total_col(obs_def%key, ifile, fileformat)
! END DART PREPROCESS READ_OBS_DEF
!
! BEGIN DART PREPROCESS WRITE_OBS_DEF
!      case(OMI_NO2_DOMINO_TOTAL_COL)
!         call write_omi_no2_domino_total_col(obs_def%key, ifile, fileformat)
! END DART PREPROCESS WRITE_OBS_DEF
!
! BEGIN DART PREPROCESS INTERACTIVE_OBS_DEF
!      case(OMI_NO2_DOMINO_TOTAL_COL)
!         call interactive_omi_no2_domino_total_col(obs_def%key)
! END DART PREPROCESS INTERACTIVE_OBS_DEF
!
! BEGIN DART PREPROCESS MODULE CODE

module obs_def_omi_no2_domino_total_col_mod
...
public :: write_omi_no2_domino_total_col, &
          read_omi_no2_domino_total_col, &
          interactive_omi_no2_domino_total_col, &
          get_expected_omi_no2_domino_total_col, &
          set_obs_def_omi_no2_domino_total_col

! Storage for the special information required for observations of this type
integer, parameter    :: max_omi_no2_domino_obs = 10000000
integer               :: num_omi_no2_domino_obs = 0
...
character(len=*), parameter :: source   = 'obs_def_omi_no2_domino_total_col_mod.f90'
...
nlayer_omi=nlayer_omi_no2_domino_total_col
...
allocate(   nlayer(max_omi_no2_domino_obs))
...
subroutine read_omi_no2_domino_total_col(key, ifile, fform)
...
if(counts1 > max_omi_no2_domino_obs) then
   write(string1, *)'Not enough space for omi no2 obs.'
   write(string2, *)'Can only have max_omi_no2_domino_obs (currently ',max_omi_no2_domino_obs,')'
   call error_handler(E_ERR,'read_omi_no2_domino_total_col',string1,source,text2=string2)
endif

call set_obs_def_omi_no2_domino_total_col(key, pressure_1, scat_wt_1, prs_trop_1, kend_1, nlayer_1)

deallocate(pressure_1, scat_wt_1)

end subroutine read_omi_no2_domino_total_col

!-------------------------------------------------------------------------------

subroutine write_omi_no2_domino_total_col(key, ifile, fform)
...
end subroutine write_omi_no2_domino_total_col

!-------------------------------------------------------------------------------

subroutine interactive_omi_no2_domino_total_col(key)
...
write(string1,*)'interactive_omi_no2_domino_total_col not yet working.'
call error_handler(E_ERR, 'interactive_omi_no2_domino_total_col', string1, source)

if(num_omi_no2_domino_obs >= max_omi_no2_domino_obs) then
   write(string1, *)'Not enough space for an omi no2 obs.'
   write(string2, *)'Can only have max_omi_no2_domino_obs (currently ',max_omi_no2_domino_obs,')'
   call error_handler(E_ERR, 'interactive_omi_no2_domino_total_col', string1, &
              source, text2=string2)
endif

! Increment the index
num_omi_no2_domino_obs = num_omi_no2_domino_obs + 1
key            = num_omi_no2_domino_obs

! Otherwise, prompt for input for the three required beasts

write(*, *) 'Creating an interactive_omi_no2_domino_total_col observation'
write(*, *) 'This featue is not setup '

end subroutine interactive_omi_no2_domino_total_col

!-------------------------------------------------------------------------------

subroutine get_expected_omi_no2_domino_total_col(state_handle, ens_size, location, key, expct_val, istatus)
   ...
   character(len=*), parameter :: routine = 'get_expected_omi_no2_domino_total_col'
   ...
   real(r8), allocatable, dimension(:)   :: no2_trop, tmp_trop, qmr_trop
   real(r8), allocatable, dimension(:,:) :: no2_val, tmp_val, qmr_val, prs_val
...
!   write(string1, *)'APM: no2 upper bound 1 ',key,no2_mdl_n
!   call error_handler(E_ALLMSG, routine, string1, source)
...
! Correcting for expected failures near the top
      ...
      enddo
!
!      write(string1, *)'APM: no2 ',key,k,no2_val(1,k)
!      call error_handler(E_ALLMSG, routine, string1, source)
...
!      call error_handler(E_ALLMSG, routine, string1, source)
      ...
      if(isnan(expct_val(imem))) then
         ...
         expct_val(:)=missing_r8
         write(string1, *) &
         'APM NOTICE: OMI NO2 expected value is NaN ',key
         call error_handler(E_ALLMSG, routine, string1, source)
         call track_status(ens_size, zstatus, expct_val, istatus, return_now)
         return
      endif
!
      if(expct_val(imem).lt.0) then
         ...
         expct_val(:)=missing_r8
         write(string1, *) &
         'APM NOTICE: OMI NO2 expected value is negative ', key
         call error_handler(E_ALLMSG, routine, string1, source)
         call track_status(ens_size, zstatus, expct_val, istatus, return_now)
         return
      endif
...
end subroutine get_expected_omi_no2_domino_total_col

!-------------------------------------------------------------------------------

subroutine set_obs_def_omi_no2_domino_total_col(key, no2_pressure, no2_scat_wt, no2_prs_trop, no2_kend, no2_nlayer)
...
if(num_omi_no2_domino_obs >= max_omi_no2_domino_obs) then
   write(string1, *)'Not enough space for omi no2 trop col obs.'
   write(string2, *)'Can only have max_omi_no2_domino_obs (currently ',max_omi_no2_domino_obs,')'
   call error_handler(E_ERR,'set_obs_def_omi_no2_domino_total_col',string1,source,revision, &
...
end subroutine set_obs_def_omi_no2_domino_total_col

end module obs_def_omi_no2_domino_total_col_mod
