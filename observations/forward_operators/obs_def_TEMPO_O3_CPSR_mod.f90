...
! TEMPO_O3_CPSR, QTY_O3
! END DART PREPROCESS KIND LIST
!
! BEGIN DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!   use obs_def_tempo_o3_cpsr_mod, only : get_expected_tempo_o3_cpsr, &
!                                  read_tempo_o3_cpsr, &
!                                  write_tempo_o3_cpsr, &
!                                  interactive_tempo_o3_cpsr
! END DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!
! BEGIN DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!      case(TEMPO_O3_CPSR)                                                           
!         call get_expected_tempo_o3_cpsr(state_handle, ens_size, location, obs_def%key, obs_time, expected_obs, istatus)  
! END DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!
! BEGIN DART PREPROCESS READ_OBS_DEF
!      case(TEMPO_O3_CPSR)
!         call read_tempo_o3_cpsr(obs_def%key, ifile, fileformat)
! END DART PREPROCESS READ_OBS_DEF
!
! BEGIN DART PREPROCESS WRITE_OBS_DEF
!      case(TEMPO_O3_CPSR)
!         call write_tempo_o3_cpsr(obs_def%key, ifile, fileformat)
! END DART PREPROCESS WRITE_OBS_DEF
!
! BEGIN DART PREPROCESS INTERACTIVE_OBS_DEF
!      case(TEMPO_O3_CPSR)
!         call interactive_tempo_o3_cpsr(obs_def%key)
! END DART PREPROCESS INTERACTIVE_OBS_DEF
!
! BEGIN DART PREPROCESS MODULE CODE

module obs_def_tempo_o3_cpsr_mod
...
! set_time sets time_type from julian day and seconds
   ...
   public :: write_tempo_o3_cpsr, &
             read_tempo_o3_cpsr, &
          interactive_tempo_o3_cpsr, &
          get_expected_tempo_o3_cpsr, &
          set_obs_def_tempo_o3_cpsr
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter :: source   = 'obs_def_tempo_o3_cpsr_mod.f90'
...
subroutine read_tempo_o3_cpsr(key, ifile, fform)
...
! Need to know how many layers for this one
   ...
   if(counts1 > max_tempo_o3_obs) then
      ...
      call error_handler(E_ERR,'read_tempo_o3_cpsr',string1,source,text2=string2)
   endif
   
   call set_obs_def_tempo_o3_cpsr(key, pressure_1, avg_kernel_1, prior_1, nlayer_1)
   
   deallocate(pressure_1, avg_kernel_1)
   
end subroutine read_tempo_o3_cpsr

!-------------------------------------------------------------------------------

subroutine write_tempo_o3_cpsr(key, ifile, fform)
...
end subroutine write_tempo_o3_cpsr

!-------------------------------------------------------------------------------

subroutine interactive_tempo_o3_cpsr(key)
...
! STOP because routine is not finished.
   write(string1,*)'interactive_tempo_o3_cpsr not yet working.'
   call error_handler(E_ERR, 'interactive_tempo_o3_cpsr', string1, source)
   
   if(num_tempo_o3_obs >= max_tempo_o3_obs) then
      write(string1, *)'Not enough space for an tempo o3 obs.'
      write(string2, *)'Can only have max_tempo_o3_obs (currently ',max_tempo_o3_obs,')'
      call error_handler(E_ERR, 'interactive_tempo_o3_cpsr', string1, &
...
! Otherwise, prompt for input for the three required beasts
   ...
   write(*, *) 'Creating an interactive_tempo_o3_cpsr observation'
   write(*, *) 'This featue is not setup '

end subroutine interactive_tempo_o3_cpsr

!-------------------------------------------------------------------------------

subroutine get_expected_tempo_o3_cpsr(state_handle, ens_size, location, key, obs_time, expct_val, istatus)
   ...
   character(len=*), parameter :: routine = 'get_expected_tempo_o3_cpsr'
...
! Get profile at TEMPO pressure levels
...
!
! Save upper BC data in the profile   
      do k=1,kstart(imem)
...
end subroutine get_expected_tempo_o3_cpsr
...
subroutine set_obs_def_tempo_o3_cpsr(key, o3_pressure, o3_avg_kernel, o3_prior, o3_nlayer)
   ...
   if(num_tempo_o3_obs >= max_tempo_o3_obs) then
      write(string1, *)'Not enough space for tempo o3 obs.'
      write(string2, *)'Can only have max_tempo_o3_obs (currently ',max_tempo_o3_obs,')'
      call error_handler(E_ERR,'set_obs_def_tempo_o3_cpsr',string1,source,revision, &
...
end subroutine set_obs_def_tempo_o3_cpsr
...
end module obs_def_tempo_o3_cpsr_mod
