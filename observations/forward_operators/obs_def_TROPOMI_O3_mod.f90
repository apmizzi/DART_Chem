...
!         call get_expected_tropomi_o3(state_handle, ens_size, location, obs_def%key, obs_time, expected_obs, istatus)  
...
subroutine get_expected_tropomi_o3(state_handle, ens_size, location, key, obs_time, expct_val, istatus)
