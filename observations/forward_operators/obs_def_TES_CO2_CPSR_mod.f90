...
! TES_CO2_CPSR, QTY_CO2
! END DART PREPROCESS TYPE DEFINITIONS
!
! BEGIN DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!   use obs_def_tes_co2_cpsr_mod, only : get_expected_tes_co2_cpsr, &
!                                  read_tes_co2_cpsr, &
!                                  write_tes_co2_cpsr, &
!                                  interactive_tes_co2_cpsr
! END DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!
! BEGIN DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!      case(TES_CO2_CPSR)                                                           
!         call get_expected_tes_co2_cpsr(state_handle, ens_size, location, obs_def%key, obs_time, expected_obs, istatus)  
! END DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!
! BEGIN DART PREPROCESS READ_OBS_DEF
!      case(TES_CO2_CPSR)
!         call read_tes_co2_cpsr(obs_def%key, ifile, fileformat)
! END DART PREPROCESS READ_OBS_DEF
!
! BEGIN DART PREPROCESS WRITE_OBS_DEF
!      case(TES_CO2_CPSR)
!         call write_tes_co2_cpsr(obs_def%key, ifile, fileformat)
! END DART PREPROCESS WRITE_OBS_DEF
!
! BEGIN DART PREPROCESS INTERACTIVE_OBS_DEF
!      case(TES_CO2_CPSR)
!         call interactive_tes_co2_cpsr(obs_def%key)
...
! set_time sets time_type from julian day and seconds
   ...
   public :: write_tes_co2_cpsr, &
             read_tes_co2_cpsr, &
          interactive_tes_co2_cpsr, &
          get_expected_tes_co2_cpsr, &
          set_obs_def_tes_co2_cpsr
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter :: source   = 'obs_def_tes_co2_cpsr_mod.f90'
...
subroutine read_tes_co2_cpsr(key, ifile, fform)
...
! Need to know how many layers for this one
   ...
   call set_obs_def_tes_co2_cpsr(key, pressure_1(1:nlayer_1+1), avg_kernel_1(1:nlayer_1), &
   prior_1(1:nlayer_1), nlayer_1, klev_1, kend_1)
   
   deallocate(pressure_1, avg_kernel_1, prior_1)
   
end subroutine read_tes_co2_cpsr

!-------------------------------------------------------------------------------

subroutine write_tes_co2_cpsr(key, ifile, fform)
...
end subroutine write_tes_co2_cpsr

!-------------------------------------------------------------------------------

subroutine interactive_tes_co2_cpsr(key)
...
! STOP because routine is not finished.
   write(string1,*)'interactive_tes_co2_cpsr not yet working.'
...
! Otherwise, prompt for input for the three required beasts
   ...
   write(*, *) 'Creating an interactive_tes_co2_cpsr observation'
   write(*, *) 'This featue is not setup '

end subroutine interactive_tes_co2_cpsr

!-------------------------------------------------------------------------------

subroutine get_expected_tes_co2_cpsr(state_handle, ens_size, location, key, obs_time, expct_val, istatus)
...
! Check data for missing values      
      do imem=1,ens_size
         ...
         qmr_val(imem,k).eq.missing_r8) then
            ...
            do imemm=1,ens_size
               write(string1, *) &
               'APM: Model cpsr values: co2,tmp,qmr',key,imem,k,co2_val(imemm,k), &
...
subroutine set_obs_def_tes_co2_cpsr(key, co2_pressure, co2_avg_kernel, co2_prior, &
...
end subroutine set_obs_def_tes_co2_cpsr
...
end module obs_def_tes_co2_cpsr_mod
