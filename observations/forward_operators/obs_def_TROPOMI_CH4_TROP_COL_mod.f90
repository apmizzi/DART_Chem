...
! TROPOMI_CH4_TROP_COL, QTY_CH4
! END DART PREPROCESS TYPE DEFINITIONS
!
! BEGIN DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!   use obs_def_tropomi_ch4_trop_col_mod, only : get_expected_tropomi_ch4_trop_col, &
!                                  read_tropomi_ch4_trop_col, &
!                                  write_tropomi_ch4_trop_col, &
!                                  interactive_tropomi_ch4_trop_col
! END DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!
! BEGIN DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!      case(TROPOMI_CH4_TROP_COL)                                                           
!         call get_expected_tropomi_ch4_trop_col(state_handle, ens_size, location, obs_def%key, expected_obs, istatus)  
! END DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!
! BEGIN DART PREPROCESS READ_OBS_DEF
!      case(TROPOMI_CH4_TROP_COL)
!         call read_tropomi_ch4_trop_col(obs_def%key, ifile, fileformat)
! END DART PREPROCESS READ_OBS_DEF
!
! BEGIN DART PREPROCESS WRITE_OBS_DEF
!      case(TROPOMI_CH4_TROP_COL)
!         call write_tropomi_ch4_trop_col(obs_def%key, ifile, fileformat)
! END DART PREPROCESS WRITE_OBS_DEF
!
! BEGIN DART PREPROCESS INTERACTIVE_OBS_DEF
!      case(TROPOMI_CH4_TROP_COL)
!         call interactive_tropomi_ch4_trop_col(obs_def%key)
! END DART PREPROCESS INTERACTIVE_OBS_DEF
!
! BEGIN DART PREPROCESS MODULE CODE

module obs_def_tropomi_ch4_trop_col_mod
...
public :: write_tropomi_ch4_trop_col, &
          read_tropomi_ch4_trop_col, &
          interactive_tropomi_ch4_trop_col, &
          get_expected_tropomi_ch4_trop_col, &
          set_obs_def_tropomi_ch4_trop_col
...
character(len=*), parameter :: source   = 'obs_def_tropomi_ch4_trop_col_mod.f90'
...
nlayer_tropomi=nlayer_tropomi_ch4_trop_col
...
allocate(    trop_indx(max_tropomi_ch4_obs))
allocate(    amf_trop(max_tropomi_ch4_obs))
...
subroutine read_tropomi_ch4_trop_col(key, ifile, fform)
...
if(counts1 > max_tropomi_ch4_obs) then
   ...
   call error_handler(E_ERR,'read_tropomi_ch4_trop_col',string1,source,text2=string2)
endif

call set_obs_def_tropomi_ch4_trop_col(key, pressure_1, avg_kernel_1, amf_trop_1, trop_indx_1, nlayer_1)

deallocate(pressure_1, avg_kernel_1)

end subroutine read_tropomi_ch4_trop_col

!-------------------------------------------------------------------------------

subroutine write_tropomi_ch4_trop_col(key, ifile, fform)
...
end subroutine write_tropomi_ch4_trop_col

!-------------------------------------------------------------------------------

subroutine interactive_tropomi_ch4_trop_col(key)
...
write(string1,*)'interactive_tropomi_ch4_trop_col not yet working.'
call error_handler(E_ERR, 'interactive_tropomi_ch4_trop_col', string1, source)

if(num_tropomi_ch4_obs >= max_tropomi_ch4_obs) then
   write(string1, *)'Not enough space for an tropomi ch4 trop colobs.'
   write(string2, *)'Can only have max_tropomi_ch4_obs (currently ',max_tropomi_ch4_obs,')'
   call error_handler(E_ERR, 'interactive_tropomi_ch4_trop_col', string1, &
...
write(*, *) 'Creating an interactive_tropomi_ch4_trop_col observation'
write(*, *) 'This featue is not setup '

end subroutine interactive_tropomi_ch4_trop_col

!-------------------------------------------------------------------------------

subroutine get_expected_tropomi_ch4_trop_col(state_handle, ens_size, location, key, expct_val, istatus)
   ...
   character(len=*), parameter :: routine = 'get_expected_tropomi_ch4_trop_col'
...
end subroutine get_expected_tropomi_ch4_trop_col

!-------------------------------------------------------------------------------

subroutine set_obs_def_tropomi_ch4_trop_col(key, ch4_pressure, ch4_avg_kernel, ch4_amf_trop, ch4_trop_indx, ch4_nlayer)

integer,                           intent(in)   :: key, ch4_nlayer
integer,                           intent(in)   :: ch4_trop_indx
real(r8),                          intent(in)   :: ch4_amf_trop
...
if(num_tropomi_ch4_obs >= max_tropomi_ch4_obs) then
   write(string1, *)'Not enough space for tropomi ch4 trop col obs.'
   write(string2, *)'Can only have max_tropomi_ch4_obs (currently ',max_tropomi_ch4_obs,')'
   call error_handler(E_ERR,'set_obs_def_tropomi_ch4_trop_col',string1,source,revision, &
   revdate,text2=string2)
endif

nlayer(key) = ch4_nlayer
trop_indx(key) = ch4_trop_indx
amf_trop(key) = ch4_amf_trop
pressure(key,1:ch4_nlayer+1) = ch4_pressure(1:ch4_nlayer+1)
avg_kernel(key,1:ch4_nlayer) = ch4_avg_kernel(1:ch4_nlayer)

end subroutine set_obs_def_tropomi_ch4_trop_col

end module obs_def_tropomi_ch4_trop_col_mod
