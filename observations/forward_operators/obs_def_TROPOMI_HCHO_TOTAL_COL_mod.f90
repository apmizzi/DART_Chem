...
! TROPOMI_HCHO_TOTAL_COL, QTY_HCHO
! END DART PREPROCESS TYPE DEFINITIONS
!
! BEGIN DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!   use obs_def_tropomi_hcho_total_col_mod, only : get_expected_tropomi_hcho_total_col, &
!                                  read_tropomi_hcho_total_col, &
!                                  write_tropomi_hcho_total_col, &
!                                  interactive_tropomi_hcho_total_col
! END DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!
! BEGIN DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!      case(TROPOMI_HCHO_TOTAL_COL)                                                           
!         call get_expected_tropomi_hcho_total_col(state_handle, ens_size, location, obs_def%key, expected_obs, istatus)  
! END DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!
! BEGIN DART PREPROCESS READ_OBS_DEF
!      case(TROPOMI_HCHO_TOTAL_COL)
!         call read_tropomi_hcho_total_col(obs_def%key, ifile, fileformat)
! END DART PREPROCESS READ_OBS_DEF
!
! BEGIN DART PREPROCESS WRITE_OBS_DEF
!      case(TROPOMI_HCHO_TOTAL_COL)
!         call write_tropomi_hcho_total_col(obs_def%key, ifile, fileformat)
! END DART PREPROCESS WRITE_OBS_DEF
!
! BEGIN DART PREPROCESS INTERACTIVE_OBS_DEF
!      case(TROPOMI_HCHO_TOTAL_COL)
!         call interactive_tropomi_hcho_total_col(obs_def%key)
! END DART PREPROCESS INTERACTIVE_OBS_DEF
!
! BEGIN DART PREPROCESS MODULE CODE

module obs_def_tropomi_hcho_total_col_mod
...
public :: write_tropomi_hcho_total_col, &
          read_tropomi_hcho_total_col, &
          interactive_tropomi_hcho_total_col, &
          get_expected_tropomi_hcho_total_col, &
          set_obs_def_tropomi_hcho_total_col
...
character(len=*), parameter :: source   = 'obs_def_tropomi_hcho_total_col_mod.f90'
...
namelist /obs_def_TROPOMI_HCHO_nml/ use_log_hcho, nlayer_model, nlayer_tropomi_hcho_total_col, &
nlayer_tropomi_hcho_trop_col
...
nlayer_tropomi=nlayer_tropomi_hcho_total_col
...
subroutine read_tropomi_hcho_total_col(key, ifile, fform)
...
if(counts1 > max_tropomi_hcho_obs) then
   ...
   call error_handler(E_ERR,'read_tropomi_hcho_total_col',string1,source,text2=string2)
endif

call set_obs_def_tropomi_hcho_total_col(key, pressure_1, avg_kernel_1, amf_trop_1, trop_indx_1, nlayer_1)

deallocate(pressure_1, avg_kernel_1)

end subroutine read_tropomi_hcho_total_col

!-------------------------------------------------------------------------------

subroutine write_tropomi_hcho_total_col(key, ifile, fform)
...
end subroutine write_tropomi_hcho_total_col

!-------------------------------------------------------------------------------

subroutine interactive_tropomi_hcho_total_col(key)
...
write(string1,*)'interactive_tropomi_hcho_total_col not yet working.'
call error_handler(E_ERR, 'interactive_tropomi_hcho_total_col', string1, source)

if(num_tropomi_hcho_obs >= max_tropomi_hcho_obs) then
   write(string1, *)'Not enough space for an tropomi hcho total colobs.'
   write(string2, *)'Can only have max_tropomi_hcho_obs (currently ',max_tropomi_hcho_obs,')'
   call error_handler(E_ERR, 'interactive_tropomi_hcho_total_col', string1, &
...
write(*, *) 'Creating an interactive_tropomi_hcho_total_col observation'
write(*, *) 'This featue is not setup '

end subroutine interactive_tropomi_hcho_total_col

!-------------------------------------------------------------------------------

subroutine get_expected_tropomi_hcho_total_col(state_handle, ens_size, location, key, expct_val, istatus)
   ...
   character(len=*), parameter :: routine = 'get_expected_tropomi_hcho_total_col'
...
end subroutine get_expected_tropomi_hcho_total_col

!-------------------------------------------------------------------------------

subroutine set_obs_def_tropomi_hcho_total_col(key, hcho_pressure, hcho_avg_kernel, hcho_amf_trop, hcho_trop_indx, hcho_nlayer)
...
if(num_tropomi_hcho_obs >= max_tropomi_hcho_obs) then
   write(string1, *)'Not enough space for tropomi hcho total col obs.'
   write(string2, *)'Can only have max_tropomi_hcho_obs (currently ',max_tropomi_hcho_obs,')'
   call error_handler(E_ERR,'set_obs_def_tropomi_hcho_total_col',string1,source,revision, &
