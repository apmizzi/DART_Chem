...
! Check for valid values
   ...
   allocate(    kmodes(max_tes_co_obs))
...
! Need to know how many layers for this one
   ...
   call set_obs_def_tes_co_cpsr(key, pressure_1(1:nlayer_1), avg_kernel_1(1:nlayer_1), &
...
!   write(string1, *)'APM: co lower bound 1 ',co_mdl_1
...
!   write(string1, *)'APM: co upper bound 1 ',co_mdl_n
!   call error_handler(E_MSG, routine, string1, source)
...
! Get profiles at TES pressure levels
   ...
   allocate(co_val(ens_size,layer_tes))
...
co_nlayer, co_kmodes, co_kend)

   integer,                           intent(in)   :: key, co_nlayer, co_kmodes, co_kend
