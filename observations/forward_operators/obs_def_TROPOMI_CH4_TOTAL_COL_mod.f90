...
! TROPOMI_CH4_TOTAL_COL, QTY_CH4
! END DART PREPROCESS TYPE DEFINITIONS
!
! BEGIN DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!   use obs_def_tropomi_ch4_total_col_mod, only : get_expected_tropomi_ch4_total_col, &
!                                  read_tropomi_ch4_total_col, &
!                                  write_tropomi_ch4_total_col, &
!                                  interactive_tropomi_ch4_total_col
! END DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!
! BEGIN DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!      case(TROPOMI_CH4_TOTAL_COL)                                                           
!         call get_expected_tropomi_ch4_total_col(state_handle, ens_size, location, obs_def%key, expected_obs, istatus)  
! END DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!
! BEGIN DART PREPROCESS READ_OBS_DEF
!      case(TROPOMI_CH4_TOTAL_COL)
!         call read_tropomi_ch4_total_col(obs_def%key, ifile, fileformat)
! END DART PREPROCESS READ_OBS_DEF
!
! BEGIN DART PREPROCESS WRITE_OBS_DEF
!      case(TROPOMI_CH4_TOTAL_COL)
!         call write_tropomi_ch4_total_col(obs_def%key, ifile, fileformat)
! END DART PREPROCESS WRITE_OBS_DEF
!
! BEGIN DART PREPROCESS INTERACTIVE_OBS_DEF
!      case(TROPOMI_CH4_TOTAL_COL)
!         call interactive_tropomi_ch4_total_col(obs_def%key)
! END DART PREPROCESS INTERACTIVE_OBS_DEF
!
! BEGIN DART PREPROCESS MODULE CODE

module obs_def_tropomi_ch4_total_col_mod
...
public :: write_tropomi_ch4_total_col, &
          read_tropomi_ch4_total_col, &
          interactive_tropomi_ch4_total_col, &
          get_expected_tropomi_ch4_total_col, &
          set_obs_def_tropomi_ch4_total_col
...
nlayer_tropomi=nlayer_tropomi_ch4_total_col
...
subroutine read_tropomi_ch4_total_col(key, ifile, fform)
...
if(counts1 > max_tropomi_ch4_obs) then
   write(string1, *)'Not enough space for tropomi ch4 total_col obs.'
...
subroutine write_tropomi_ch4_total_col(key, ifile, fform)
...
subroutine interactive_tropomi_ch4_total_col(key)
...
write(string1,*)'interactive_tropomi_ch4_total_col not yet working.'
call error_handler(E_ERR, 'interactive_tropomi_ch4_total_col', string1, source)

if(num_tropomi_ch4_obs >= max_tropomi_ch4_obs) then
   write(string1, *)'Not enough space for an tropomi ch4 total_col obs.'
   write(string2, *)'Can only have max_tropomi_ch4_obs (currently ',max_tropomi_ch4_obs,')'
   call error_handler(E_ERR, 'interactive_tropomi_ch4_total_col', string1, &
...
write(*, *) 'Creating an interactive_tropomi_ch4_total_col observation'
write(*, *) 'This featue is not setup '

end subroutine interactive_tropomi_ch4_total_col

!-------------------------------------------------------------------------------

subroutine get_expected_tropomi_ch4_total_col(state_handle, ens_size, location, key, expct_val, istatus)
   ...
   character(len=*), parameter :: routine = 'get_expected_tropomi_ch4_total_col'
...
if(num_tropomi_ch4_obs >= max_tropomi_ch4_obs) then
   ...
   write(string2, *)'Can only have max_tropomi_ch4_obs (currently ',max_tropomi_ch4_obs,')'
   call error_handler(E_ERR,'set_obs_def_tropomi_ch4_total_col',string1,source,revision, &
...
end module obs_def_tropomi_ch4_total_col_mod
