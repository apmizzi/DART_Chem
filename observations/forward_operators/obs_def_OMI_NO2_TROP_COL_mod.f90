...
! OMI_NO2_TROP_COL, QTY_NO2
! END DART PREPROCESS TYPE DEFINITIONS
!
! BEGIN DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!   use obs_def_omi_no2_trop_col_mod, only : get_expected_omi_no2_trop_col, &
!                                   read_omi_no2_trop_col, &
!                                   write_omi_no2_trop_col, &
!                                   interactive_omi_no2_trop_col
! END DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!
! BEGIN DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!      case(OMI_NO2_TROP_COL)                                                           
!         call get_expected_omi_no2_trop_col(state_handle, ens_size, location, obs_def%key, expected_obs, istatus)  
! END DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!
! BEGIN DART PREPROCESS READ_OBS_DEF
!      case(OMI_NO2_TROP_COL)
!         call read_omi_no2_trop_col(obs_def%key, ifile, fileformat)
! END DART PREPROCESS READ_OBS_DEF
!
! BEGIN DART PREPROCESS WRITE_OBS_DEF
!      case(OMI_NO2_TROP_COL)
!         call write_omi_no2_trop_col(obs_def%key, ifile, fileformat)
! END DART PREPROCESS WRITE_OBS_DEF
!
! BEGIN DART PREPROCESS INTERACTIVE_OBS_DEF
!      case(OMI_NO2_TROP_COL)
!         call interactive_omi_no2_trop_col(obs_def%key)
...
public :: write_omi_no2_trop_col, &
          read_omi_no2_trop_col, &
          interactive_omi_no2_trop_col, &
          get_expected_omi_no2_trop_col, &
          set_obs_def_omi_no2_trop_col
...
character(len=*), parameter :: source   = 'obs_def_omi_no2_trop_col_mod.f90'
...
subroutine read_omi_no2_trop_col(key, ifile, fform)
...
if(counts1 > max_omi_no2_obs) then
   ...
   call error_handler(E_ERR,'read_omi_no2_trop_col',string1,source,text2=string2)
endif

call set_obs_def_omi_no2_trop_col(key, pressure_1, scat_wt_1, prs_trop_1, kend_1, nlayer_1)

deallocate(pressure_1, scat_wt_1)

end subroutine read_omi_no2_trop_col

!-------------------------------------------------------------------------------

subroutine write_omi_no2_trop_col(key, ifile, fform)
...
end subroutine write_omi_no2_trop_col

!-------------------------------------------------------------------------------

subroutine interactive_omi_no2_trop_col(key)
...
write(string1,*)'interactive_omi_no2_trop_col not yet working.'
call error_handler(E_ERR, 'interactive_omi_no2_trop_col', string1, source)

if(num_omi_no2_obs >= max_omi_no2_obs) then
   write(string1, *)'Not enough space for an omi no2 obs.'
   write(string2, *)'Can only have max_omi_no2_obs (currently ',max_omi_no2_obs,')'
   call error_handler(E_ERR, 'interactive_omi_no2_trop_col', string1, &
...
write(*, *) 'Creating an interactive_omi_no2_trop_col observation'
write(*, *) 'This featue is not setup '

end subroutine interactive_omi_no2_trop_col

!-------------------------------------------------------------------------------

subroutine get_expected_omi_no2_trop_col(state_handle, ens_size, location, key, expct_val, istatus)
   ...
   character(len=*), parameter :: routine = 'get_expected_omi_no2_trop_col'
...
end subroutine get_expected_omi_no2_trop_col

!-------------------------------------------------------------------------------

subroutine set_obs_def_omi_no2_trop_col(key, no2_pressure, no2_scat_wt, no2_prs_trop, no2_kend, no2_nlayer)
...
if(num_omi_no2_obs >= max_omi_no2_obs) then
   ...
   write(string2, *)'Can only have max_omi_no2_obs (currently ',max_omi_no2_obs,')'
   call error_handler(E_ERR,'set_obs_def_omi_no2_trop_col',string1,source,revision, &
...
end subroutine set_obs_def_omi_no2_trop_col
...
end module obs_def_omi_no2_trop_col_mod
