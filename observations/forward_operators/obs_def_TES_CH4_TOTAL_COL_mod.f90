...
! TES_CH4_TOTAL_COL, QTY_CH4
! END DART PREPROCESS TYPE DEFINITIONS
!
! BEGIN DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!   use obs_def_tes_ch4_total_col_mod, only : get_expected_tes_ch4_total_col, &
!                                  read_tes_ch4_total_col, &
!                                  write_tes_ch4_total_col, &
!                                  interactive_tes_ch4_total_col
! END DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!
! BEGIN DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!      case(TES_CH4_TOTAL_COL)                                                           
!         call get_expected_tes_ch4_total_col(state_handle, ens_size, location, obs_def%key, obs_time, expected_obs, istatus)  
! END DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!
! BEGIN DART PREPROCESS READ_OBS_DEF
!      case(TES_CH4_TOTAL_COL)
!         call read_tes_ch4_total_col(obs_def%key, ifile, fileformat)
! END DART PREPROCESS READ_OBS_DEF
!
! BEGIN DART PREPROCESS WRITE_OBS_DEF
!      case(TES_CH4_TOTAL_COL)
!         call write_tes_ch4_total_col(obs_def%key, ifile, fileformat)
! END DART PREPROCESS WRITE_OBS_DEF
!
! BEGIN DART PREPROCESS INTERACTIVE_OBS_DEF
!      case(TES_CH4_TOTAL_COL)
!         call interactive_tes_ch4_total_col(obs_def%key)
! END DART PREPROCESS INTERACTIVE_OBS_DEF
!
! BEGIN DART PREPROCESS MODULE CODE

module obs_def_tes_ch4_total_col_mod
...
! set_time sets time_type from julian day and seconds
   ...
   public :: write_tes_ch4_total_col, &
             read_tes_ch4_total_col, &
          interactive_tes_ch4_total_col, &
          get_expected_tes_ch4_total_col, &
          set_obs_def_tes_ch4_total_col
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter :: source   = 'obs_def_tes_ch4_total_col_mod.f90'
...
! Namelist with default values
   ...
   namelist /obs_def_TES_CH4_nml/ use_log_ch4, nlayer_model, &
...
! Check for valid values
   nlayer_tes=nlayer_tes_ch4_total_col
   ...
   allocate(  pressure(max_tes_ch4_obs,nlayer_tes+1))
...
subroutine read_tes_ch4_total_col(key, ifile, fform)
...
! Need to know how many layers for this one
   ...
   if(counts1 > max_tes_ch4_obs) then
      ...
      call error_handler(E_ERR,'read_tes_ch4_total_col',string1,source,text2=string2)
   endif
   
   call set_obs_def_tes_ch4_total_col(key, pressure_1(1:nlayer_1+1), avg_kernel_1(1:nlayer_1), &
   prior_1(1:nlayer_1), nlayer_1, klev_1, kend_1)
   
   deallocate(pressure_1, avg_kernel_1, prior_1)
   
end subroutine read_tes_ch4_total_col

!-------------------------------------------------------------------------------

subroutine write_tes_ch4_total_col(key, ifile, fform)
...
end subroutine write_tes_ch4_total_col

!-------------------------------------------------------------------------------

subroutine interactive_tes_ch4_total_col(key)
...
! STOP because routine is not finished.
   write(string1,*)'interactive_tes_ch4_total_col not yet working.'
   call error_handler(E_ERR, 'interactive_tes_ch4_total_col', string1, source)
   
   if(num_tes_ch4_obs >= max_tes_ch4_obs) then
      write(string1, *)'Not enough space for an tes ch4 obs.'
      write(string2, *)'Can only have max_tes_ch4_obs (currently ',max_tes_ch4_obs,')'
      call error_handler(E_ERR, 'interactive_tes_ch4_total_col', string1, &
...
! Otherwise, prompt for input for the three required beasts
   ...
   write(*, *) 'Creating an interactive_tes_ch4_total_col observation'
   write(*, *) 'This featue is not setup '

end subroutine interactive_tes_ch4_total_col

!-------------------------------------------------------------------------------

subroutine get_expected_tes_ch4_total_col(state_handle, ens_size, location, key, obs_time, expct_val, istatus)
   ...
   character(len=*), parameter :: routine = 'get_expected_tes_ch4_total_col'
...
!
         call get_upper_bdy_ch4(lon_obs,lat_obs,prs_tes_top,ncnt, &
...
end subroutine get_expected_tes_ch4_total_col
...
subroutine set_obs_def_tes_ch4_total_col(key, ch4_pressure, ch4_avg_kernel, ch4_prior, &
ch4_nlayer, ch4_klev, ch4_kend)
   ...
   if(num_tes_ch4_obs >= max_tes_ch4_obs) then
      write(string1, *)'Not enough space for tes ch4 obs.'
      write(string2, *)'Can only have max_tes_ch4_obs (currently ',max_tes_ch4_obs,')'
      call error_handler(E_ERR,'set_obs_def_tes_ch4_total_col',string1,source,revision, &
...
end subroutine set_obs_def_tes_ch4_total_col
...
end module obs_def_tes_ch4_total_col_mod
