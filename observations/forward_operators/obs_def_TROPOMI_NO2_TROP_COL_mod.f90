...
! TROPOMI_NO2_TROP_COL, QTY_NO2
! END DART PREPROCESS TYPE DEFINITIONS
!
! BEGIN DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!   use obs_def_tropomi_no2_trop_col_mod, only : get_expected_tropomi_no2_trop_col, &
!                                  read_tropomi_no2_trop_col, &
!                                  write_tropomi_no2_trop_col, &
!                                  interactive_tropomi_no2_trop_col
! END DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!
! BEGIN DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!      case(TROPOMI_NO2_TROP_COL)                                                           
!         call get_expected_tropomi_no2_trop_col(state_handle, ens_size, location, obs_def%key, expected_obs, istatus)  
! END DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!
! BEGIN DART PREPROCESS READ_OBS_DEF
!      case(TROPOMI_NO2_TROP_COL)
!         call read_tropomi_no2_trop_col(obs_def%key, ifile, fileformat)
! END DART PREPROCESS READ_OBS_DEF
!
! BEGIN DART PREPROCESS WRITE_OBS_DEF
!      case(TROPOMI_NO2_TROP_COL)
!         call write_tropomi_no2_trop_col(obs_def%key, ifile, fileformat)
! END DART PREPROCESS WRITE_OBS_DEF
!
! BEGIN DART PREPROCESS INTERACTIVE_OBS_DEF
!      case(TROPOMI_NO2_TROP_COL)
!         call interactive_tropomi_no2_trop_col(obs_def%key)
...
public :: write_tropomi_no2_trop_col, &
          read_tropomi_no2_trop_col, &
          interactive_tropomi_no2_trop_col, &
          get_expected_tropomi_no2_trop_col, &
          set_obs_def_tropomi_no2_trop_col
...
nlayer_tropomi=nlayer_tropomi_no2_trop_col
...
subroutine read_tropomi_no2_trop_col(key, ifile, fform)
...
if(counts1 > max_tropomi_no2_obs) then
   write(string1, *)'Not enough space for tropomi no2 trop col obs.'
...
subroutine write_tropomi_no2_trop_col(key, ifile, fform)
...
subroutine interactive_tropomi_no2_trop_col(key)
...
write(string1,*)'interactive_tropomi_no2_trop_col not yet working.'
call error_handler(E_ERR, 'interactive_tropomi_no2_trop_col', string1, source)

if(num_tropomi_no2_obs >= max_tropomi_no2_obs) then
   write(string1, *)'Not enough space for an tropomi no2 trop colobs.'
   write(string2, *)'Can only have max_tropomi_no2_obs (currently ',max_tropomi_no2_obs,')'
   call error_handler(E_ERR, 'interactive_tropomi_no2_trop_col', string1, &
...
write(*, *) 'Creating an interactive_tropomi_no2_trop_col observation'
write(*, *) 'This featue is not setup '

end subroutine interactive_tropomi_no2_trop_col

!-------------------------------------------------------------------------------

subroutine get_expected_tropomi_no2_trop_col(state_handle, ens_size, location, key, expct_val, istatus)
   ...
   character(len=*), parameter :: routine = 'get_expected_tropomi_no2_trop_col'
...
end subroutine get_expected_tropomi_no2_trop_col
...
if(num_tropomi_no2_obs >= max_tropomi_no2_obs) then
   write(string1, *)'Not enough space for tropomi no2 trop col obs.'
   write(string2, *)'Can only have max_tropomi_no2_obs (currently ',max_tropomi_no2_obs,')'
   call error_handler(E_ERR,'set_obs_def_tropomi_no2_trop_col',string1,source,revision, &
...
end module obs_def_tropomi_no2_trop_col_mod
