...
! TROPOMI_CH4_CPSR, QTY_CH4
! END DART PREPROCESS TYPE DEFINITIONS
!
! BEGIN DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!   use obs_def_tropomi_ch4_cpsr_mod, only : get_expected_tropomi_ch4_cpsr, &
!                                  read_tropomi_ch4_cpsr, &
!                                  write_tropomi_ch4_cpsr, &
!                                  interactive_tropomi_ch4_cpsr
! END DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!
! BEGIN DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!      case(TROPOMI_CH4_CPSR)                                                           
!         call get_expected_tropomi_ch4_cpsr(state_handle, ens_size, location, obs_def%key, expected_obs, istatus)  
! END DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!
! BEGIN DART PREPROCESS READ_OBS_DEF
!      case(TROPOMI_CH4_CPSR)
!         call read_tropomi_ch4_cpsr(obs_def%key, ifile, fileformat)
! END DART PREPROCESS READ_OBS_DEF
!
! BEGIN DART PREPROCESS WRITE_OBS_DEF
!      case(TROPOMI_CH4_CPSR)
!         call write_tropomi_ch4_cpsr(obs_def%key, ifile, fileformat)
! END DART PREPROCESS WRITE_OBS_DEF
!
! BEGIN DART PREPROCESS INTERACTIVE_OBS_DEF
!      case(TROPOMI_CH4_CPSR)
!         call interactive_tropomi_ch4_cpsr(obs_def%key)
! END DART PREPROCESS INTERACTIVE_OBS_DEF
!
! BEGIN DART PREPROCESS MODULE CODE

module obs_def_tropomi_ch4_cpsr_mod
...
public :: write_tropomi_ch4_cpsr, &
          read_tropomi_ch4_cpsr, &
          interactive_tropomi_ch4_cpsr, &
          get_expected_tropomi_ch4_cpsr, &
          set_obs_def_tropomi_ch4_cpsr
...
character(len=*), parameter :: source   = 'obs_def_tropomi_ch4_cpsr_mod.f90'
...
subroutine read_tropomi_ch4_cpsr(key, ifile, fform)
...
if(counts1 > max_tropomi_ch4_obs) then
   ...
   call error_handler(E_ERR,'read_tropomi_ch4_cpsr',string1,source,text2=string2)
endif

call set_obs_def_tropomi_ch4_cpsr(key, pressure_1, avg_kernel_1, amf_trop_1, trop_indx_1, nlayer_1)

deallocate(pressure_1, avg_kernel_1)

end subroutine read_tropomi_ch4_cpsr

!-------------------------------------------------------------------------------

subroutine write_tropomi_ch4_cpsr(key, ifile, fform)
...
end subroutine write_tropomi_ch4_cpsr

!-------------------------------------------------------------------------------

subroutine interactive_tropomi_ch4_cpsr(key)
...
write(string1,*)'interactive_tropomi_ch4_cpsr not yet working.'
call error_handler(E_ERR, 'interactive_tropomi_ch4_cpsr', string1, source)

if(num_tropomi_ch4_obs >= max_tropomi_ch4_obs) then
   write(string1, *)'Not enough space for an tropomi ch4 trop colobs.'
   write(string2, *)'Can only have max_tropomi_ch4_obs (currently ',max_tropomi_ch4_obs,')'
   call error_handler(E_ERR, 'interactive_tropomi_ch4_cpsr', string1, &
...
write(*, *) 'Creating an interactive_tropomi_ch4_cpsr observation'
write(*, *) 'This featue is not setup '

end subroutine interactive_tropomi_ch4_cpsr

!-------------------------------------------------------------------------------

subroutine get_expected_tropomi_ch4_cpsr(state_handle, ens_size, location, key, expct_val, istatus)
   ...
   character(len=*), parameter :: routine = 'get_expected_tropomi_ch4_cpsr'
...
end subroutine get_expected_tropomi_ch4_cpsr

!-------------------------------------------------------------------------------

subroutine set_obs_def_tropomi_ch4_cpsr(key, ch4_pressure, ch4_avg_kernel, ch4_amf_trop, ch4_trop_indx, ch4_nlayer)
...
if(num_tropomi_ch4_obs >= max_tropomi_ch4_obs) then
   write(string1, *)'Not enough space for tropomi ch4 trop col obs.'
   write(string2, *)'Can only have max_tropomi_ch4_obs (currently ',max_tropomi_ch4_obs,')'
   call error_handler(E_ERR,'set_obs_def_tropomi_ch4_cpsr',string1,source,revision, &
...
end subroutine set_obs_def_tropomi_ch4_cpsr

end module obs_def_tropomi_ch4_cpsr_mod
