...
! TROPOMI_SO2_TOTAL_COL, QTY_SO2
! END DART PREPROCESS KIND LIST
!
! BEGIN DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!   use obs_def_tropomi_so2_total_col_mod, only : get_expected_tropomi_so2_total_col, &
!                                  read_tropomi_so2_total_col, &
!                                  write_tropomi_so2_total_col, &
!                                  interactive_tropomi_so2_total_col
! END DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!
! BEGIN DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!      case(TROPOMI_SO2_TOTAL_COL)                                                           
!         call get_expected_tropomi_so2_total_col(state_handle, ens_size, location, obs_def%key, expected_obs, istatus)  
! END DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!
! BEGIN DART PREPROCESS READ_OBS_DEF
!      case(TROPOMI_SO2_TOTAL_COL)
!         call read_tropomi_so2_total_col(obs_def%key, ifile, fileformat)
! END DART PREPROCESS READ_OBS_DEF
!
! BEGIN DART PREPROCESS WRITE_OBS_DEF
!      case(TROPOMI_SO2_TOTAL_COL)
!         call write_tropomi_so2_total_col(obs_def%key, ifile, fileformat)
! END DART PREPROCESS WRITE_OBS_DEF
!
! BEGIN DART PREPROCESS INTERACTIVE_OBS_DEF
!      case(TROPOMI_SO2_TOTAL_COL)
!         call interactive_tropomi_so2_total_col(obs_def%key)
! END DART PREPROCESS INTERACTIVE_OBS_DEF
!
! BEGIN DART PREPROCESS MODULE CODE

module obs_def_tropomi_so2_total_col_mod
...
public :: write_tropomi_so2_total_col, &
          read_tropomi_so2_total_col, &
          interactive_tropomi_so2_total_col, &
          get_expected_tropomi_so2_total_col, &
          set_obs_def_tropomi_so2_total_col
...
character(len=*), parameter :: source   = 'obs_def_tropomi_so2_total_col_mod.f90'
...
nlayer_tropomi=nlayer_tropomi_so2_total_col
...
subroutine read_tropomi_so2_total_col(key, ifile, fform)
...
call set_obs_def_tropomi_so2_total_col(key, pressure_1, avg_kernel_1, prior_1, amf_obs_1, nlayer_1, kend_1)

deallocate(pressure_1, avg_kernel_1, prior_1)

end subroutine read_tropomi_so2_total_col

!-------------------------------------------------------------------------------

subroutine write_tropomi_so2_total_col(key, ifile, fform)
...
end subroutine write_tropomi_so2_total_col

!-------------------------------------------------------------------------------

subroutine interactive_tropomi_so2_total_col(key)
...
write(string1,*)'interactive_tropomi_so2_total_col not yet working.'
call error_handler(E_ERR, 'interactive_tropomi_so2_total_col', string1, source)

if(num_tropomi_so2_obs >= max_tropomi_so2_obs) then
   write(string1, *)'Not enough space for an tropomi so2 obs.'
   write(string2, *)'Can only have max_tropomi_so2_obs (currently ',max_tropomi_so2_obs,')'
   call error_handler(E_ERR, 'interactive_tropomi_so2_total_col', string1, &
...
write(*, *) 'Creating an interactive_tropomi_so2_total_col observation'
write(*, *) 'This featue is not setup '

end subroutine interactive_tropomi_so2_total_col

!-------------------------------------------------------------------------------

subroutine get_expected_tropomi_so2_total_col(state_handle, ens_size, location, key, expct_val, istatus)
...
character(len=*), parameter :: routine = 'get_expected_tropomi_so2_total_col'
...
end subroutine get_expected_tropomi_so2_total_col

!-------------------------------------------------------------------------------

subroutine set_obs_def_tropomi_so2_total_col(key, so2_pressure, so2_avg_kernel, so2_prior, so2_amf_obs, so2_nlayer, so2_kend)
...
end subroutine set_obs_def_tropomi_so2_total_col
...
end module obs_def_tropomi_so2_total_col_mod
