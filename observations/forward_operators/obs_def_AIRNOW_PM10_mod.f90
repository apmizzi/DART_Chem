...
!   case(AIRNOW_PM10)
!        call get_expected_airnow_pm10(state_handle, ens_size, location, obs_def%key, expected_obs, istatus) 
...
subroutine get_expected_airnow_pm10(state_handle, ens_size, location, key, val, istatus)  
   ...
   logical                          :: return_now
   character(len=*), parameter :: routine = 'get_expected_airnow_pm10'
!
