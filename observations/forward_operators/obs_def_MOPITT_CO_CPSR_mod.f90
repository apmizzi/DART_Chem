...
! MOPITT_CO_CPSR, QTY_CO
! END DART PREPROCESS TYPE DEFINITIONS

! BEGIN DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!   use obs_def_mopitt_co_cpsr_mod, only : write_mopitt_co_cpsr, read_mopitt_co_cpsr, &
!                                  interactive_mopitt_co_cpsr, get_expected_mopitt_co_cpsr, &
!                                  set_obs_def_mopitt_co_cpsr
! END DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE

! BEGIN DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!         case(MOPITT_CO_CPSR)                                                           
!            call get_expected_mopitt_co_cpsr(state_handle, ens_size, location, obs_def%key, expected_obs, istatus)  
! END DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF

! BEGIN DART PREPROCESS READ_OBS_DEF
!      case(MOPITT_CO_CPSR)
!         call read_mopitt_co_cpsr(obs_def%key, ifile, fileformat)
! END DART PREPROCESS READ_OBS_DEF

! BEGIN DART PREPROCESS WRITE_OBS_DEF
!      case(MOPITT_CO_CPSR)
!         call write_mopitt_co_cpsr(obs_def%key, ifile, fileformat)
! END DART PREPROCESS WRITE_OBS_DEF

! BEGIN DART PREPROCESS INTERACTIVE_OBS_DEF
!      case(MOPITT_CO_CPSR)
!         call interactive_mopitt_co_cpsr(obs_def%key)
! END DART PREPROCESS INTERACTIVE_OBS_DEF

! BEGIN DART PREPROCESS SET_OBS_DEF_MOPITT_CO_CPSR
!      case(MOPITT_CO_CPSR)
!         call set_obs_def_mopitt_co_cpsr(obs_def%key)
! END DART PREPROCESS SET_OBS_DEF_MOPITT_CO_CPSR
...
module obs_def_mopitt_co_cpsr_mod
   ...
   public :: write_mopitt_co_cpsr, &
             read_mopitt_co_cpsr, &
             interactive_mopitt_co_cpsr, &
             get_expected_mopitt_co_cpsr, &
             set_obs_def_mopitt_co_cpsr
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter :: source   = 'obs_def_MOPITT_CO_CPSR_mod.f90'
...
subroutine read_mopitt_co_cpsr(key, ifile, fform)
!----------------------------------------------------------------------
!subroutine read_mopitt_co_cpsr(key, ifile, fform)
...
counts1 = counts1 + 1
key = counts1
call set_obs_def_mopitt_co_cpsr(key, avg_kernels_1, mopitt_prior_1, &
     mopitt_psurf_1, mopitt_nlayers_1)

end subroutine read_mopitt_co_cpsr

 subroutine write_mopitt_co_cpsr(key, ifile, fform)
!----------------------------------------------------------------------
!subroutine write_mopitt_co_cpsr(key, ifile, fform)
...
SELECT CASE (fileformat)
   ...
   write(ifile, *) key
END SELECT 
end subroutine write_mopitt_co_cpsr
!
subroutine interactive_mopitt_co_cpsr(key)
!----------------------------------------------------------------------
!subroutine interactive_mopitt_co_cpsr(key)
!
...
if(num_mopitt_co_obs >= MAX_MOPITT_CO_OBS) then
   ...
   call error_handler(E_ERR,'interactive_mopitt_co_cpsr',string1,source,revision,revdate, text2=string2)
endif
...
write(*, *) 'Creating an interactive_mopitt_co_cpsr observation'
...
end subroutine interactive_mopitt_co_cpsr
!
subroutine get_expected_mopitt_co_cpsr(state_handle, ens_size, location, key, val, istatus)
!----------------------------------------------------------------------
!subroutine get_expected_mopitt_co_cpsr(state_handle, ens_size, location, key, val, istatus)
...
!
   ...
   character(len=*), parameter :: routine = 'get_expected_mopitt_co_cpsr'
   logical :: return_now
!
! Initialize DART
...
! Get profile at MOPITT pressure levels
   do imem=1,ens_size   
...
!
end subroutine get_expected_mopitt_co_cpsr
!
!----------------------------------------------------------------------

 subroutine set_obs_def_mopitt_co_cpsr(key, co_avgker, co_prior, co_psurf, co_nlayers)
!----------------------------------------------------------------------
...
if(num_mopitt_co_obs >= MAX_MOPITT_CO_OBS) then
   write(string1, *)'Not enough space for a mopitt CO obs.'
   call error_handler(E_MSG,'set_obs_def_mopitt_co_cpsr',string1,source,revision,revdate)
   write(string1, *)'Can only have MAX_MOPITT_CO_OBS (currently ',MAX_MOPITT_CO_OBS,')'
   call error_handler(E_ERR,'set_obs_def_mopitt_co_cpsr',string1,source,revision,revdate)
endif
...
end subroutine set_obs_def_mopitt_co_cpsr
...
end module obs_def_mopitt_co_cpsr_mod
