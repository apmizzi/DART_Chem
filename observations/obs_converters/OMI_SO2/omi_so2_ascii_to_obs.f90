...
!=============================================
   ...
   use obs_def_omi_so2_mod, only     : set_obs_def_omi_so2
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter     :: source   = 'omi_so2_ascii_to_obs.f90'
...
!
      ...
      call set_obs_def_omi_so2(qc_count, prs_obs_r8, scat_wt_r8, nlay_obs, kend)
