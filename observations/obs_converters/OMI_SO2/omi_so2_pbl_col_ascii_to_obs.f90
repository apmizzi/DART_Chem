...
!
program omi_so2_pbl_col_ascii_to_obs
!
!=============================================
! OMI SO2 pbl column obs
!=============================================
   ...
   use obs_def_omi_so2_pbl_col_mod, only    : set_obs_def_omi_so2_pbl_col
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter     :: source   = 'omi_so2_pbl_col_ascii_to_obs.f90'
...
!
   ...
   character*129                   :: file_name='omi_so2_pbl_col_obs_seq'
...
!
   ...
   ny_model,nz_model,obs_o3_reten_freq,obs_no2_reten_freq,obs_so2_reten_freq,obs_hcho_reten_freq
!
! Set constants
   pi=4.*atan(1.)
   rad2deg=360./(2.*pi)
...
!
         ...
         call set_obs_def_omi_so2_pbl_col(qc_count, prs_obs_r8, scat_wt_r8, nlay_obs, kend)
...
!
end program omi_so2_pbl_col_ascii_to_obs
!
