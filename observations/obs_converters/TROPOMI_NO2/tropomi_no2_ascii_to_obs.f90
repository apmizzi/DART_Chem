...
!--------------------------------------------------------
!
      call vertical_locate(prs_loc,prs_obs,nlev_obs,avgk_obs,nlay_obs,trop_indx)
      level=prs_loc*100.
...
!
      ...
      call set_obs_def_tropomi_no2(qc_count, prs_obs, avgk_obs, amf_trop_obs, trop_indx, nlay_obs)
