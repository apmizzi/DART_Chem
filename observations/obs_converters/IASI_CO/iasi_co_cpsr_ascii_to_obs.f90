...
program iasi_co_cpsr_ascii_to_obs
...
use obs_def_IASI_CO_CPSR_mod, only : set_obs_def_iasi_co_cpsr
...
character(len=*), parameter :: source   = 'iasi_co_cpsr_ascii_to_obs.f90'
...
character*129           :: file_name='iasi_co_cpsr_obs_seq'
...
!
           ...
           call set_obs_def_iasi_co_cpsr(qc_count, co_avgker, co_press, co_prior, co_psurf, &
...
end program iasi_co_cpsr_ascii_to_obs
!
