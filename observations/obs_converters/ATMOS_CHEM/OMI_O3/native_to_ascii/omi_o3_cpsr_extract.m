function omi_o3_cpsr_extract (filein,fileout,file_pre,cwyr_mn,cwmn_mn,cwdy_mn,cwhh_mn,cwmm_mn,cwss_mn,cwyr_mx,cwmn_mx,cwdy_mx,cwhh_mx,cwmm_mx,cwss_mx,path_mdl,file_mdl,cnx_mdl,cny_mdl)
%
...
% Save profile data to ascii file  
            icnt=icnt+1;
            fprintf(fid,'OMI_O3_CPSR_Obs: %d %d %d \n',icnt,i_min,j_min);
