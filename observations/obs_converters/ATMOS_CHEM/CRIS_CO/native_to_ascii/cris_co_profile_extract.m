function cris_co_profile_extract (filein,fileout,file_pre,cwyr_mn,cwmn_mn,cwdy_mn,cwhh_mn,cwmm_mn,cwss_mn,cwyr_mx,cwmn_mx,cwdy_mx,cwhh_mx,cwmm_mx,cwss_mx,path_mdl,file_mdl,cnx_mdl,cny_mdl)  
%
...
%
% co_lay (nlay,ntarg) (VMR)
      field='/x';
      co_lay=ncread(file_in,field);
%
% co_lay_prior (nlay,ntarg) (VMR)
      field='/observation_ops/xa';
      co_lay_prior=ncread(file_in,field);
%
...
% Save data to ascii file
         ...
         fprintf(fid,'\n');
         fprintf(fid,'%14.8g ',co_lay(1:nlay,itarg));
         fprintf(fid,'\n');
         fprintf(fid,'%14.8g ',co_lay_prior(1:nlay,itarg));
         fprintf(fid,'\n');
