...
!
program cris_co_total_col_ascii_to_obs
!
!=============================================
! CRIS CO column obs
!=============================================
   ...
   use obs_def_cris_co_total_col_mod, only     : set_obs_def_cris_co_total_col
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter     :: source   = 'cris_co_total_col_ascii_to_obs.f90'
...
!
   ...
   character*129                   :: file_name='cris_co_total_col_obs_seq'
...
!
            ...
            call set_obs_def_cris_co_total_col(qc_count, prs_obs_r8(1:nlay_obs), &
...
!
end program cris_co_total_col_ascii_to_obs
!
