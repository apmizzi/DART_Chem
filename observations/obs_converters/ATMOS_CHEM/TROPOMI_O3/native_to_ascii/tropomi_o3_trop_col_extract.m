function tropomi_o3_trop_col_extract (filein,fileout,file_pre,cwyr_mn,cwmn_mn,cwdy_mn,cwhh_mn,cwmm_mn,cwss_mn,cwyr_mx,cwmn_mx,cwdy_mx,cwhh_mx,cwmm_mx,cwss_mx,path_mdl,file_mdl,cnx_mdl,cny_mdl)
%
...
% col_amt(pixel,scanline) (mol m-2)
      ...
      trop_top_prs=ncreadatt(file_in,field,'vertical_range_top');
      units=ncreadatt(file_in,field,'units');
      standard_name=ncreadatt(file_in,field,'standard_name');
      long_name=ncreadatt(file_in,field,'long_name');
