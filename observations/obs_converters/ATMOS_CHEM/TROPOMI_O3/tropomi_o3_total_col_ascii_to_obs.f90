...
!
program tropomi_o3_total_col_ascii_to_obs
!
!=============================================
...
!=============================================
   ...
   use obs_def_tropomi_o3_total_col_mod, only     : set_obs_def_tropomi_o3_total_col
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter     :: source   = 'tropomi_o3_total_col_ascii_to_obs.f90'
...
!
   ...
   character*129                   :: file_name='tropomi_o3_total_col_obs_seq'
...
!      
         ...
         call set_obs_def_tropomi_o3_total_col(qc_count, prs_obs_r8, avgk_obs_r8, prior_obs_r8, nlay_obs, kend)
...
!
end program tropomi_o3_total_col_ascii_to_obs
