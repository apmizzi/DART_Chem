...
!
program cris_o3_profile_ascii_to_obs
!
!=============================================
! CRIS O3 column obs
!=============================================
   ...
   use obs_def_cris_o3_profile_mod, only     : set_obs_def_cris_o3_profile
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter     :: source   = 'cris_o3_profile_ascii_to_obs.f90'
...
!
   ...
   character*129                   :: qc_meta_data='CRIS O3 QC index'
   character*129                   :: chr_year,chr_month,chr_day
   character*129                   :: file_name='cris_o3_profile_obs_seq'
...
!
   do icopy =1, num_copies
      if (icopy == 1) then
         copy_meta_data='CRIS O3 observation'
      else
...
! Read CRIS O3
   ...
   do while (ios == 0)
      ...
      enddo
      print *, 'CRIS O3: Completed data read'      
!
      prs_obs(:)=prs_obs(:)*100.
      do k=1,nlay_obs
...
! CRIS O3 and WRF-Chem vertical grids are bottom to top        
!--------------------------------------------------------
!      reject=0
...
!
            ...
            call set_obs_def_cris_o3_profile(qc_count, prs_obs_r8(1:nlay_obs), &
...
!
end program cris_o3_profile_ascii_to_obs
!
