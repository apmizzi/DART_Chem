...
!
program sciam_no2_total_col_ascii_to_obs
!
!=============================================
...
!=============================================
   ...
   use obs_def_sciam_no2_total_col_mod, only     : set_obs_def_sciam_no2_total_col
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter     :: source   = 'sciam_no2_total_col_ascii_to_obs.f90'
...
!
   ...
   character*129                   :: file_name='sciam_no2_total_col_obs_seq'
...
!
   namelist /create_sciam_obs_nml/filedir,filename,fileout, &
...
!        
         ...
         call set_obs_def_sciam_no2_total_col(qc_count, prs_obs_r8, &
...
!
end program sciam_no2_total_col_ascii_to_obs
