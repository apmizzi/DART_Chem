function gome2b_no2_trop_col_extract (filein,fileout,file_pre,cwyr_mn,cwmn_mn,cwdy_mn,cwhh_mn,cwmm_mn,cwss_mn,cwyr_mx,cwmn_mx,cwdy_mx,cwhh_mx,cwmm_mx,cwss_mx,path_mdl,file_mdl,cnx_mdl,cny_mdl)
%
...
% Loop through GOME2B data
      ...
      for itim=1:ntim
	    ...
	    mm_gome2b=minute;
	    ss_gome2b=second;
            gome2bdate=single(convert_time_ref(year,month,day,hour,minute,second,1995));
%
% Check time
%            fprintf('APM: min %d, gome2b %d, max %d \n',windate_min,gome2bdate,windate_max);
            if(gome2bdate<windate_min | gome2bdate>windate_max)
               continue
            end
	    for ipxl=1:npxl
%
...
% Save data to ascii file
	       icnt=icnt+1;
               fprintf(fid,'GOME2B_NO2_Obs: %d %d %d \n',icnt,i_min,j_min);
               fprintf(fid,'%d %d %d %d %d %d \n',yyyy_gome2b, ...
               mn_gome2b,dy_gome2b,hh_gome2b,mm_gome2b,ss_gome2b);
