function cris_nh3_profile_extract (filein,fileout,file_pre,cwyr_mn,cwmn_mn,cwdy_mn,cwhh_mn,cwmm_mn,cwss_mn,cwyr_mx,cwmn_mx,cwdy_mx,cwhh_mx,cwmm_mx,cwss_mx,path_mdl,file_mdl,cnx_mdl,cny_mdl)  
%
...
%
% nh3_lay (nlay,ntarg) (VMR)
      field='/x';
      nh3_lay=ncread(file_in,field);
%
% nh3_lay_prior (nlay,ntarg) (VMR)
      field='/observation_ops/xa';
      nh3_lay_prior=ncread(file_in,field);
%
...
% Save data to ascii file
         icnt=icnt+1;
         fprintf(fid,'CRIS_NH3_Obs: %d %d %d \n',icnt,i_min,j_min);
         ...
         fprintf(fid,'\n');
         fprintf(fid,'%14.8g ',nh3_lay(1:nlay,itarg));
         fprintf(fid,'\n');
         fprintf(fid,'%14.8g ',nh3_lay_prior(1:nlay,itarg));
         fprintf(fid,'\n');
