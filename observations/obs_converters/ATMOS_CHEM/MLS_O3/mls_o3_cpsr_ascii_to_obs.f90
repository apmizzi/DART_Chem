...
!=============================================
  ...
  use utilities_mod, only          : timestamp,                  &
   ...
   use obs_def_mls_o3_cpsr_mod, only     : set_obs_def_mls_o3_cpsr
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter     :: source   = 'mls_o3_cpsr_ascii_to_obs.f90'
...
!
   ...
   character*129                   :: file_name='mls_o3_cpsr_obs_seq'
...
!
end program mls_o3_cpsr_ascii_to_obs
