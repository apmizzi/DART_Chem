...
!
program tempo_no2_total_col_ascii_to_obs
!
!=============================================
...
!=============================================
   ...
   use obs_def_tempo_no2_total_col_mod, only     : set_obs_def_tempo_no2_total_col
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter     :: source   = 'tempo_no2_total_col_ascii_to_obs.f90'
...
!
   ...
   character*129                   :: file_name='tempo_no2_total_col_obs_seq'
...
!        
         ...
         call set_obs_def_tempo_no2_total_col(qc_count, prs_obs_r8, &
...
!
end program tempo_no2_total_col_ascii_to_obs
