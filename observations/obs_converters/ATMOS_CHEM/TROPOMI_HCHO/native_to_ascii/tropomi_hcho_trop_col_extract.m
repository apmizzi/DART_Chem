function tropomi_hcho_trop_col_extract (filein,fileout,file_pre,cwyr_mn,cwmn_mn,cwdy_mn,cwhh_mn,cwmm_mn,cwss_mn,cwyr_mx,cwmn_mx,cwdy_mx,cwhh_mx,cwmm_mx,cwss_mx,path_mdl,file_mdl,cnx_mdl,cny_mdl)
%
...
% Define TROPOMI vertical pressure grid (hPa) (top to bottom)
      for ipxl=1:npxl
         for ilin=1:nscan
            for ilay=1:nlay
               prs_lay(ilay,ipxl,ilin)=tm5_a(ilay)+tm5_b(ilay)* ...
               prs_sfc(ipxl,ilin);
            end
         end
      end
