...
program iasi_o3_profile_ascii_to_obs
...
!
   ...
   use obs_def_IASI_O3_PROFILE_mod, only : set_obs_def_iasi_o3_profile
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter :: source   = 'iasi_o3_profile_ascii_to_obs.f90'
...
!
   ...
   character*129           :: file_name='iasi_o3_profile_obs_seq'
...
!
           ...
           call set_obs_def_iasi_o3_profile(qc_count, o3_avgker, o3_press, o3_prior_trm, &
...
end program iasi_o3_profile_ascii_to_obs
