...
!
program iasi_co_total_col_ascii_to_obs
!
!=============================================
! IASI CO total column obs
!=============================================
  ...
  use apm_upper_bdy_mod, only      : get_upper_bdy_fld, &
   ...
   use obs_def_iasi_co_total_col_mod, only   : set_obs_def_iasi_co_total_col
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter     :: source   = 'iasi_co_total_col_ascii_to_obs.f90'
...
!
   ...
   real*8                          :: obs_err_var
!
   real*8,dimension(num_qc)        :: iasi_qc
...
!
   ...
   character*129                   :: file_name='iasi_co_total_col_obs_seq'
...
! Read IASI CO
   ...
   do while (ios == 0)
      ...
      read(fileid,*,iostat=ios) col_amt_err_obs
...
!
      ...
      call set_obs_def_iasi_co_total_col(qc_count, avgk_obs, prior_obs, nlay_obs)
      call set_obs_def_key(obs_def, qc_count)
      call set_obs_values(obs, obs_val, 1)
      call set_qc(obs, iasi_qc, num_qc)
...
!
end program iasi_co_total_col_ascii_to_obs
