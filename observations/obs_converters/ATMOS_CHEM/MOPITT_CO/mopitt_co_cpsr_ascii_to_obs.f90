...
program mopitt_co_cpsr_ascii_to_obs
...
use obs_def_mopitt_co_cpsr_mod, only : set_obs_def_mopitt_co_cpsr
...
character(len=*), parameter :: source   = 'mopitt_co_cpsr_ascii_to_obs.f90'
...
character*129           :: file_name='mopitt_co_cpsr_obs_seq'
...
!
           ...
           call set_obs_def_mopitt_co_cpsr(qc_count, co_avgker, co_prior, co_psurf, &
           xg_nlvls(i,j))
...
end program mopitt_co_cpsr_ascii_to_obs
