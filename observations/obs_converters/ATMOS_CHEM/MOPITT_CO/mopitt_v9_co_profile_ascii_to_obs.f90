...
!
program mopitt_v9_co_profile_ascii_to_obs
!
!=============================================
! MOPITT V9 CO profile obs
!=============================================
!  
   ...
   use obs_def_mopitt_v9_co_profile_mod, only : set_obs_def_mopitt_v9_co_profile
   use obs_kind_mod, only            : MOPITT_V9_CO_PROFILE

   implicit none
!
! version controlled file description for error handling, do not edit
   character(len=*), parameter :: source   = 'mopitt_v9_co_profile_ascii_to_obs.f90'
...
!
   ...
   character(len=129)                :: file_name='mopitt_v9_co_profile_obs_seq'
...
!
         ...
         kobs(1)=sum_total
         kobs(2)=ilv
         call set_obs_def_mopitt_v9_co_profile(qc_count, prs_lev_r8, avgk_lay_r8, &
...
!
end program mopitt_v9_co_profile_ascii_to_obs
