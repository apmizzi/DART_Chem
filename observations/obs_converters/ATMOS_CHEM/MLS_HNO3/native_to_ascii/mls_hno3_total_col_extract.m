function mls_hno3_total_col_extract (filein,fileout,file_pre,cwyr_mn,cwmn_mn,cwdy_mn,cwhh_mn,cwmm_mn,cwss_mn,cwyr_mx,cwmn_mx,cwdy_mx,cwhh_mx,cwmm_mx,cwss_mx,path_mdl,file_mdl,cnx_mdl,cny_mdl)
%
...
%
% hno3_lay (layer,ntrk,nstep)
      field='/product/ozone_profile';
      hno3_lay=ncread(file_in,field);
%
...
% Save data to ascii file
	    if (icnt==1000)
	      return
            ...
            fprintf(fid,'\n');
            fprintf(fid,'%14.8g ',hno3_lay(1:layer,ixtrk,istep));
            fprintf(fid,'\n');
