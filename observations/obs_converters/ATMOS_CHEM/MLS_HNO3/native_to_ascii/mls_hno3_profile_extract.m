function mls_hno3_profile_extract (filein,fileout,file_pre,cwyr_mn,cwmn_mn,cwdy_mn,cwhh_mn,cwmm_mn,cwss_mn,cwyr_mx,cwmn_mx,cwdy_mx,cwhh_mx,cwmm_mx,cwss_mx,path_mdl,file_mdl,cnx_mdl,cny_mdl)  
%
...
% 1d_0N Data
   ...
   gfid=netcdf.inqNcid(wfid,'HNO3');
   dimid=netcdf.inqDimID(gfid,'RetrievalLevel');
   [name,ret_nlay]=netcdf.inqDim(gfid,dimid);
   dimid=netcdf.inqDimID(gfid,'TruthLevel');
   [name,tru_nlay]=netcdf.inqDim(gfid,dimid);
...
%
% ret_lay_0N(ret_nlay)
   field='/HNO3/RetrievalLevel';
   ret_lay_0N=ncread(file_in,field);
%
% tru_lay_0N(tru_nlay)
   field='/HNO3/TruthLevel';
...
% Process satellite data
   for ifile=1:nfile
      ...
      clear hno3_lay vert_col_total vert_col_trop
...
%
% Time (ntime)
      field='/HDFEOS/SWATHS/HNO3/Geolocation Fields/Time';
      time=h5read(file_in,field);
      dmy=size(time);
      ntime=dmy(1);
%
% HNO3 Profile (layer,ntime) (VMR)     
      field='/HDFEOS/SWATHS/HNO3/Data Fields/L2gpValue';
      hno3_obs=h5read(file_in,field);
      hno3_units=h5readatt(file_in,field,'Units');
      clear dmy
      dmy=size(hno3_obs);
      layer=dmy(1);
      level=layer+1;
%
% HNO3 Profile Error (layer,ntime)     
      field='/HDFEOS/SWATHS/HNO3/Data Fields/L2gpPrecision';
      hno3_obs_err=h5read(file_in,field);
%
% HNO3 Profile Convergence (ntime)      
      field='/HDFEOS/SWATHS/HNO3/Data Fields/Convergence';
      hno3_obs_conv=h5read(file_in,field);
%
% HNO3 Profile Quality (ntime)
      field='/HDFEOS/SWATHS/HNO3/Data Fields/Quality';
      hno3_obs_qual=h5read(file_in,field);
%
% HNO3 Profile Status (ntime)
      field='/HDFEOS/SWATHS/HNO3/Data Fields/Status';
      hno3_obs_status=h5read(file_in,field);
%
% lat (ntime)
      field='/HDFEOS/SWATHS/HNO3/Geolocation Fields/Latitude';
      lat=h5read(file_in,field);
%
% lon (ntime)
      field='/HDFEOS/SWATHS/HNO3/Geolocation Fields/Longitude';
...
%
% HNO3 Column (ntime)
%      field='/HDFEOS/SWATHS/HNO3 column/Data Fields/L2gpValue';
%      hno3_col_obs=h5read(file_in,field);
%
% HNO3 Column Error (ntime) 
...
%
% HNO3 A Prior Convergence (ntime)  
      field='/HDFEOS/SWATHS/HNO3-APriori/Data Fields/Convergence';
      hno3_prior_conv=h5read(file_in,field);
%
% HNO3 Prior Quality (ntime)
      field='/HDFEOS/SWATHS/HNO3-APriori/Data Fields/Quality';
      hno3_prior_qual=h5read(file_in,field);
%
% HNO3 Prior Status (ntime)
      field='/HDFEOS/SWATHS/HNO3-APriori/Data Fields/Status';
      hno3_prior_status=h5read(file_in,field);
%
