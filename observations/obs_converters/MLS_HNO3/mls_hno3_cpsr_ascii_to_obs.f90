...
! Species-specific variables
   ...
   real*8,allocatable,dimension(:)   :: hno3_obs_r8
...
! Read MLS HNO3
   ...
   do while (ios == 0)
      ...
      allocate(hno3_shift(nlay_obs),prior_shift(nlay_obs))
...
!
      ...
      if(flg.eq.1) then
         ...
         deallocate(hno3_shift,prior_shift)
...
! Calculate CPSRs for this retrieval profile
         call cpsr_calculation(nmodes,nlayer,hno3_cpsr,avgk_cpsr,prior_cpsr,hno3_shift,prior_shift, &
         avgk_shift,cov_shift)
!
! Loop through the dominant modes (OMI HNO3 is top to bottom)
         do imds=1,nmodes
...
!
            ...
            call set_obs_def_mls_hno3_cpsr(qc_count, prs_obs_r8(:), avgk_obs_r8(:), prior_obs_r8, nlayer, klev, kend)
