...
!
program mls_hno3_profile_ascii_to_obs
!
!=============================================
! MLS HNO3 column obs
!=============================================
   ...
   use obs_def_mls_hno3_profile_mod, only     : set_obs_def_mls_hno3_profile
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter     :: source   = 'mls_hno3_profile_ascii_to_obs.f90'
...
!
   ...
   character*129                   :: file_name='mls_hno3_profile_obs_seq'
...
!
            ...
            call set_obs_def_mls_hno3_profile(qc_count, prs_obs_r8(1:nlay_obs), &
...
!
end program mls_hno3_profile_ascii_to_obs
!
