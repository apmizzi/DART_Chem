...
!
program tes_nh3_profile_ascii_to_obs
!
!=============================================
! TES NH3 column obs
!=============================================
   ...
   use obs_def_tes_nh3_profile_mod, only     : set_obs_def_tes_nh3_profile
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter     :: source   = 'tes_nh3_profile_ascii_to_obs.f90'
...
!
   ...
   character*129                   :: file_name='tes_nh3_profile_obs_seq'
...
!
end program tes_nh3_profile_ascii_to_obs
!
