...
!
program tempo_no2_ascii_to_obs
!
!=============================================
...
!=============================================
   ...
   use obs_def_tempo_no2_mod, only     : set_obs_def_tempo_no2
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter     :: source   = 'tempo_no2_ascii_to_obs.f90'
...
!
   ...
   character*129                   :: file_name='tempo_no2_obs_seq'
...
! Species-specific variables
   ...
   real*8                          :: col_amt_trop_obs, amf_total_obs, amf_trop_obs
   real*8                          :: prs_trop_obs
...
!
      ...
      call set_obs_def_tempo_no2(qc_count, prs_obs, &
...
!
end program tempo_no2_ascii_to_obs
!
