...
!
program iasi_co_col_ascii_to_obs
!
!=============================================
! IASI CO column obs
!=============================================
   ...
   use obs_def_iasi_co_col_mod, only   : set_obs_def_iasi_co_col
...
!
   ...
   character*129                   :: file_name='iasi_co_obs_seq'
...
!
      ...
      call set_obs_def_iasi_co_col(qc_count, avgk_obs, prior_obs, nlay_obs)
...
!
end program iasi_co_col_ascii_to_obs
!
