...
!
program tropomi_ch4_trop_col_ascii_to_obs
!
!=============================================
...
!=============================================
   ...
   use obs_def_tropomi_ch4_trop_col_mod, only     : set_obs_def_tropomi_ch4_trop_col
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter     :: source   = 'tropomi_ch4_trop_col_ascii_to_obs.f90'
...
!
   ...
   character*129                   :: file_name='tropomi_ch4_trop_col_obs_seq'
...
!       
         ...
         call set_obs_def_tropomi_ch4_trop_col(qc_count, prs_obs_r8, avgk_obs_r8, amf_trop_obs_r8, trop_indx, nlay_obs)
...
!
end program tropomi_ch4_trop_col_ascii_to_obs
!
