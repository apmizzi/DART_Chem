...
!
program tropomi_o3_profile_ascii_to_obs
!
!=============================================
...
!=============================================
   ...
   use obs_def_tropomi_o3_profile_mod, only     : set_obs_def_tropomi_o3_profile
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter     :: source   = 'tropomi_o3_profile_ascii_to_obs.f90'
...
!
   ...
   character*129                   :: file_name='tropomi_o3_profile_obs_seq'
...
!
         ...
         call set_obs_def_tropomi_o3_profile(qc_count, prs_obs_r8, avgk_obs_r8, prior_obs_r8, nlay_obs, kend)
...
!
end program tropomi_o3_profile_ascii_to_obs
!
