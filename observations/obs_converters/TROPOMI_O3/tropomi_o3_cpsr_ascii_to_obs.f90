...
!
program tropomi_o3_cpsr_ascii_to_obs
!
!=============================================
...
!=============================================
   ...
   use obs_def_tropomi_o3_cpsr_mod, only     : set_obs_def_tropomi_o3_cpsr
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter     :: source   = 'tropomi_o3_cpsr_ascii_to_obs.f90'
...
!
   ...
   character*129                   :: file_name='tropomi_o3_cpsr_obs_seq'
...
! Read TROPOMI O3
   ...
   do while (ios == 0)
      ...
      enddo
      do k=1,nlay_obs
         read(fileid,*,iostat=ios) cov_obs(k,1:nlay_obs)
      enddo
...
!      
            ...
            call set_obs_def_tropomi_o3_cpsr(qc_count, prs_obs_r8(:), avgk_obs_r8(:), prior_obs_r8, nlayer)
...
!
end program tropomi_o3_cpsr_ascii_to_obs
!
