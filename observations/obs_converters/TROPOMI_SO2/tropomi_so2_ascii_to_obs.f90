...
!
program tropomi_so2_ascii_to_obs
!
!=============================================
! TROPOMI SO2 column obs
!=============================================
   ...
   use obs_def_tropomi_so2_mod, only     : set_obs_def_tropomi_so2
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter     :: source   = 'tropomi_so2_ascii_to_obs.f90'
...
!
   ...
   character*129                   :: file_name='tropomi_so2_obs_seq'
...
!
      ...
      call set_obs_def_tropomi_so2(qc_count, prs_obs_r8, avgk_obs_r8, &
