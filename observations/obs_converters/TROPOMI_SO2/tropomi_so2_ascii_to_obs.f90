...
! Species-specific variables
   real*8                          :: col_amt_1km,col_amt_1km_err,col_amt_1km_sys
   real*8                          :: col_amt_7km,col_amt_7km_err,col_amt_7km_sys
   real*8                          :: amf_1km,amf_1km_err,amf_1km_sys
...
!
      ...
      call set_obs_def_tropomi_so2(qc_count, prs_obs_r8, avgk_obs_r8, prior_obs_r8, amf_1km, nlay_obs)
...
subroutine get_model_profile(prf_model,path_model,file_model, &
   ...
   real,dimension(nlev_obs)               :: so2_mdl,vtmp_mdl,prs_obs
...
! Find model point closest to the observation point and de vertical interpolation
   call interp_hori_vert(so2_mdl,vtmp_mdl,so2_fld,vtmp_fld,lon,lat, &
