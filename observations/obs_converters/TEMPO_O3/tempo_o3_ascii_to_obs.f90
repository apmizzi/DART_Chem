...
!=============================================
   ...
   use obs_def_tempo_o3_mod, only     : set_obs_def_tempo_o3
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter     :: source   = 'tempo_o3_ascii_to_obs.f90'
...
!
   ...
   character*129                   :: file_name='tempo_o3_obs_seq'
   character*129                   :: data_type,cmd
!
   logical                         :: use_log_o3,use_log_no2
!
! Species-specific variables
   real*8                          :: col_amt_total_obs, col_amt_total_err_obs
   real*8                          :: col_amt_trop_obs, col_amt_pbl_obs
   real*8                          :: amf_total_obs, amf_trop_obs
   real*8                          :: prs_trop_obs
   real*8,allocatable,dimension(:) :: scat_wts_obs
!
   namelist /create_tempo_obs_nml/filedir,filename,year,month,day,hour, &
   bin_beg,bin_end,fac_obs_error,use_log_o3,use_log_no2, &
...
! Read TEMPO O3
   ...
   do while (ios == 0)
      ...
      read(fileid,*,iostat=ios) col_amt_total_err_obs
      read(fileid,*,iostat=ios) col_amt_trop_obs
      read(fileid,*,iostat=ios) col_amt_pbl_obs
...
!      print *, prs_trop
!      print *, col_amt_total_obs
!      print *, col_amt_total_err_obs
!      print *, col_amt_trop_obs
!      print *, col_amt_pbl_obs
!      print *, amf_total
!      print *, amf_trop
!
! Set data for writing obs_sequence file
      ...
      obs_err_var=(fac*col_amt_trop_obs)**2.
      tempo_qc(:)=0
...
!--------------------------------------------------------
!
      call vertical_locate(prs_loc,prs_obs,nlev_obs,scat_wts_obs,nlay_obs)
      level=prs_loc*100.
      which_vert=2       ! pressure surface
!
      obs_kind = TEMPO_O3_COLUMN
...
!
      ...
      call set_obs_def_tempo_o3(qc_count, prs_obs, &
      scat_wts_obs, prs_trop_obs, amf_trop_obs, nlay_obs)
...
!
end program tempo_o3_ascii_to_obs
!
