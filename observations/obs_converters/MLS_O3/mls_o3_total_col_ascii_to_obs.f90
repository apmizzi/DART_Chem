...
!
program mls_o3_total_col_ascii_to_obs
!
!=============================================
! MLS O3 column obs
!=============================================
   ...
   use obs_def_mls_o3_total_col_mod, only     : set_obs_def_mls_o3_total_col
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter     :: source   = 'mls_o3_total_col_ascii_to_obs.f90'
...
!
   ...
   character*129                   :: file_name='mls_o3_total_col_obs_seq'
...
!        
         ...
         call set_obs_def_mls_o3_total_col(qc_count, prs_obs_r8(:), avgk_total_obs_r8(:), prior_total_r8, nlay_obs, klev, kend)
...
!
end program mls_o3_total_col_ascii_to_obs
!
