...
!=============================================
   ...
   use obs_def_omi_o3_mod, only     : set_obs_def_omi_o3
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter     :: source   = 'omi_o3_ascii_to_obs.f90'
...
!
      ...
      call set_obs_def_omi_o3(qc_count, prs_obs_r8, avgk_obs_r8, prior_obs_r8, nlay_obs, kend)
...
!
end program omi_o3_ascii_to_obs
!
