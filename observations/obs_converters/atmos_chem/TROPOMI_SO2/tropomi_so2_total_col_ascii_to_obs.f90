...
!
program tropomi_so2_total_col_ascii_to_obs
!
!=============================================
! TROPOMI SO2_TOTAL_COL column obs
!=============================================
   ...
   use obs_def_tropomi_so2_total_col_mod, only     : set_obs_def_tropomi_so2_total_col
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter     :: source   = 'tropomi_so2_total_col_ascii_to_obs.f90'
...
!
   ...
   character*129                   :: file_name='tropomi_so2_total_col_obs_seq'
...
!      print *, amf_1km_clr
!      print *, col_amt_7km
!      print *, col_amt_7km_err
!      print *, col_amt_7km_sys
!      print *, amf_7km
!      print *, amf_7km_err
!      print *, amf_7km_sys
!      print *, amf_7km_cld
...
!--------------------------------------------------------
      ...
      qmr_fld(i_min,j_min,:),so2_fld(i_min,j_min,:), &
...
!      
         obs_kind = TROPOMI_SO2_TOTAL_COL
...
!      
         ...
         call set_obs_def_tropomi_so2_total_col(qc_count, prs_obs_r8, avgk_obs_r8, &
...
!
end program tropomi_so2_total_col_ascii_to_obs
!
