...
!
program tes_co_profile_ascii_to_obs
!
!=============================================
! TES CO column obs
!=============================================
   ...
   use obs_def_tes_co_profile_mod, only     : set_obs_def_tes_co_profile
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter     :: source   = 'tes_co_profile_ascii_to_obs.f90'
...
!
   ...
   character*129                   :: file_name='tes_co_profile_obs_seq'
...
!
end program tes_co_profile_ascii_to_obs
!
