...
!
program tropomi_ch4_profile_ascii_to_obs
!
!=============================================
! TROPOMI CH4 column obs
!=============================================
   ...
   use obs_def_tropomi_ch4_profile_mod, only     : set_obs_def_tropomi_ch4_profile
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter     :: source   = 'tropomi_ch4_profile_ascii_to_obs.f90'
...
!
   ...
   character*129                   :: qc_meta_data='TROPOMI CH4 QC index'
   character*129                   :: chr_year,chr_month,chr_day
   character*129                   :: file_name='tropomi_ch4_profile_obs_seq'
...
! Species-specific variables
   ...
   real                            :: total_col_obs, total_col_obs_err
...
!
   do icopy =1, num_copies
      if (icopy == 1) then
         copy_meta_data='TROPOMI CH4 observation'
      else
...
! Read TROPOMI CH4
   ...
   do while (ios == 0)
      ...
      read(fileid,*,iostat=ios) alt_obs(1:nlev_obs)
      read(fileid,*,iostat=ios) avgk_obs(1:nlay_obs)
      read(fileid,*,iostat=ios) prior_obs(1:nlay_obs)
      read(fileid,*,iostat=ios) total_col_obs, total_col_obs_err
      alt_obs_r8(:)=alt_obs(:)
...
!       
         ...
         call set_obs_def_tropomi_ch4_profile(qc_count, alt_obs_r8, avgk_obs_r8, prior_obs_r8, nlay_obs)
...
!
end program tropomi_ch4_profile_ascii_to_obs
!
