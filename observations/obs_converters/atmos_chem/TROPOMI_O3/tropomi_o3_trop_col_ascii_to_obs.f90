...
!
program tropomi_o3_trop_col_ascii_to_obs
!
!=============================================
...
!=============================================
   ...
   use obs_def_tropomi_o3_trop_col_mod, only     : set_obs_def_tropomi_o3_trop_col
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter     :: source   = 'tropomi_o3_trop_col_ascii_to_obs.f90'
...
!
   ...
   character*129                   :: file_name='tropomi_o3_trop_col_obs_seq'
...
! Species-specific variables
   ...
   real                            :: trop_sum,trop_top_prs,strat_sum
   real*8                          :: trop_top_prs_r8
...
! Read TROPOMI O3
   ...
   do while (ios == 0)
      ...
      read(fileid,*,iostat=ios) trop_top_prs
...
! kend is the TROPOMI index for the last vertical level that
! contains the model vertical profile      
!--------------------------------------------------------
      reject=0
...
!      
         ...
         call set_obs_def_tropomi_o3_trop_col(qc_count, prs_obs_r8, avgk_obs_r8, prior_obs_r8, trop_top_prs_r8, nlay_obs)
...
!
end program tropomi_o3_trop_col_ascii_to_obs
!
