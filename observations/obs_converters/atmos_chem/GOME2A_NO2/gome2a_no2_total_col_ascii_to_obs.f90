...
!
program gome2a_no2_total_col_ascii_to_obs
!
!=============================================
...
!=============================================
   ...
   use obs_def_gome2a_no2_total_col_mod, only     : set_obs_def_gome2a_no2_total_col
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter     :: source   = 'gome2a_no2_total_col_ascii_to_obs.f90'
...
!
   ...
   character*129                   :: qc_meta_data='GOME2A NO2 QC index'
   character*129                   :: chr_year,chr_month,chr_day
   character*129                   :: file_name='gome2a_no2_total_col_obs_seq'
...
!
   namelist /create_gome2a_obs_nml/filedir,filename,fileout, &
...
! Record the namelist values used for the run ...
   call error_handler(E_MSG,'init_create_gome2a_obs','create_gome2a_obs_nml values are',' ',' ',' ')
   write(     *     , nml=create_gome2a_obs_nml)
!
...
!
   do icopy =1, num_copies
      if (icopy == 1) then
         copy_meta_data='GOME2A NO2 observation'
      else
...
!        
         ...
         call set_obs_def_gome2a_no2_total_col(qc_count, prs_obs_r8, &
...
!
end program gome2a_no2_total_col_ascii_to_obs
!
