...
# Delete these directories
	    ...
	    rm -rf NOAA/preprocess_obs/index_*
	    ...
	    rm -rf NOAA/preprocess_obs/wrfbiochemi_d01*
	    rm -rf NOAA/preprocess_obs/wrfchemi_d01*
	    rm -rf NOAA/preprocess_obs/wrffirechemi_d01*
	    rm -rf NOAA/preprocess_obs/wrf_dart_obs_preprocess*
	    rm -rf NOAA/preprocess_obs/wrfinput_d01
	    rm -rf exo_coldens
	    rm -rf localization
 	    rm -rf real/*_real.o*
	    rm -rf real/hist_io_flds*
	    rm -rf real/index*
	    rm -rf real/job*
	    rm -rf real/met_em*
	    rm -rf real/namelist*
	    ...
	    rm -rf wrfchem_chem_icbc/*_mozbc_*
	    ...
	    rm -rf wrfchem_met_bc/input.nml
