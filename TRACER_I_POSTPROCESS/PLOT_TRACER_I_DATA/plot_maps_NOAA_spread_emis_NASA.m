function plot_maps_NOAA_spread_emis_NASA
   clear all;
%
   ...
   nz=20;
   num_mem=30;
   rc=system('rm -rf NOAA_PRIOR_SPREAD_EMIS.eps');
   save_file='NOAA_PRIOR_SPREAD_EMIS.eps';
%
% set colormap
...
%
   WRFCHEM_CHEM_EMIS_DIR=strcat('wrfchem_chem_emiss');
%
% CHEM DA
...
%
      ...
      for imem=1:num_mem
         ...
         exp_pr=strcat(path_data,strcat('/',DATE_STR_PR(idate),'/',WRFCHEM_CHEM_EMIS_DIR,'/wrfchemi_d01_',file_date,run_dir))
%
% CO PRIOR FIELDS
         fac=1.e3;
         state_var='E_CO'; 
