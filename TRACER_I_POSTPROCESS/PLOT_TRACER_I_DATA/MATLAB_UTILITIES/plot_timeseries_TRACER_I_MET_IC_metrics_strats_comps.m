function plot_timeseries_TRACER_I_MET_IC_metrics_strats_comps
   clear all;
%
   DATE_STR=2012040200;
   DATE_END=2012040200;
   ...
   ny=284;
   nz=50;
   rc=system('rm -rf TRACER_I_MET_IC_metrics_strats_comps.eps');
   save_file='TRACER_I_MET_IC_metrics_strats_comps.eps';
%
% set colormap
...
% T field
      ...
      t_traceri_conus_mn(icnt)=fld_full(wrf_vert(levl))*fac;        %ppbv
%      t_traceri_conus_mn(1)
%
      state_var='TRACER_I_T_CONUS_SD'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      t_traceri_conus_sd(icnt)=fld_full(wrf_vert(levl))*fac;        %ppbv
%      t_traceri_conus_sd(1)
%
      state_var='TCR2_T_CONUS_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      t_tcr2_conus_mn(icnt)=fld_full(wrf_vert(levl))*fac;            %ppbv
%      t_tcr2_conus_mn(1)
%
      state_var='WRFCMAQ_T_CONUS_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      t_wrfcmaq_conus_mn(icnt)=fld_full(wrf_vert(levl))*fac;         %ppbv
%      t_wrfcmaq_conus_mn(1)
%
      state_var='CAMCHEM_T_CONUS_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      t_camchem_conus_mn(icnt)=fld_full(wrf_vert(levl))*fac;         %ppbv
%      t_camchem_conus_mn(1)
%
      state_var='TRACER_I_T_URBAN_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      t_traceri_urban_mn(icnt)=fld_full(wrf_vert(levl))*fac;        %ppbv
%      t_traceri_urban_mn(1)
%
      state_var='TRACER_I_T_URBAN_SD'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      t_traceri_urban_sd(icnt)=fld_full(wrf_vert(levl))*fac;        %ppbv
%      t_traceri_urban_sd(1)
%
      state_var='TCR2_T_URBAN_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      t_tcr2_urban_mn(icnt)=fld_full(wrf_vert(levl))*fac;            %ppbv
%      t_tcr2_urban_mn(1)
%
      state_var='WRFCMAQ_T_URBAN_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      t_wrfcmaq_urban_mn(icnt)=fld_full(wrf_vert(levl))*fac;         %ppbv
%      t_wrfcmaq_urban_mn(1)
%
      state_var='CAMCHEM_T_URBAN_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      t_camchem_urban_mn(icnt)=fld_full(wrf_vert(levl))*fac;         %ppbv
%      t_camchem_urban_mn(1)
%
      state_var='TRACER_I_T_RURAL_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      t_traceri_rural_mn(icnt)=fld_full(wrf_vert(levl))*fac;        %ppbv
%      t_traceri_rural_mn(1)
%
      state_var='TRACER_I_T_RURAL_SD'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      t_traceri_rural_sd(icnt)=fld_full(wrf_vert(levl))*fac;        %ppbv
%      t_traceri_rural_sd(1)
%
      state_var='TCR2_T_RURAL_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      t_tcr2_rural_mn(icnt)=fld_full(wrf_vert(levl))*fac;            %ppbv
%      t_tcr2_rural_mn(1)
%
      state_var='WRFCMAQ_T_RURAL_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      t_wrfcmaq_rural_mn(icnt)=fld_full(wrf_vert(levl))*fac;         %ppbv
%      t_wrfcmaq_rural_mn(1)
%
      state_var='CAMCHEM_T_RURAL_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      t_camchem_rural_mn(icnt)=fld_full(wrf_vert(levl))*fac;         %ppbv
...
% U field
      ...
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      u_traceri_conus_mn(icnt)=fld_full(wrf_vert(levl))*fac;        %ppbv
%      u_traceri_conus_mn(1)
%
      state_var='TRACER_I_U_CONUS_SD'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      u_traceri_conus_sd(icnt)=fld_full(wrf_vert(levl))*fac;        %ppbv
%      u_traceri_conus_sd(1)
%
      state_var='TCR2_U_CONUS_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      u_tcr2_conus_mn(icnt)=fld_full(wrf_vert(levl))*fac;            %ppbv
%      u_tcr2_conus_mn(1)
%
      state_var='WRFCMAQ_U_CONUS_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      u_wrfcmaq_conus_mn(icnt)=fld_full(wrf_vert(levl))*fac;         %ppbv
%      u_wrfcmaq_conus_mn(1)
%
      state_var='CAMCHEM_U_CONUS_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      u_camchem_conus_mn(icnt)=fld_full(wrf_vert(levl))*fac;         %ppbv
%      u_camchem_conus_mn(1)
%
      state_var='TRACER_I_U_URBAN_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      u_traceri_urban_mn(icnt)=fld_full(wrf_vert(levl))*fac;        %ppbv
%      u_traceri_urban_mn(1)
%
      state_var='TRACER_I_U_URBAN_SD'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      u_traceri_urban_sd(icnt)=fld_full(wrf_vert(levl))*fac;        %ppbv
%      u_traceri_urban_sd(1)
%
      state_var='TCR2_U_URBAN_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      u_tcr2_urban_mn(icnt)=fld_full(wrf_vert(levl))*fac;            %ppbv
%      u_tcr2_urban_mn(1)
%
      state_var='WRFCMAQ_U_URBAN_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      u_wrfcmaq_urban_mn(icnt)=fld_full(wrf_vert(levl))*fac;         %ppbv
%      u_wrfcmaq_urban_mn(1)
%
      state_var='CAMCHEM_U_URBAN_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      u_camchem_urban_mn(icnt)=fld_full(wrf_vert(levl))*fac;         %ppbv
%      u_camchem_urban_mn(1)
%
      state_var='TRACER_I_U_RURAL_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      u_traceri_rural_mn(icnt)=fld_full(wrf_vert(levl))*fac;        %ppbv
%      u_traceri_rural_mn(1)
%
      state_var='TRACER_I_U_RURAL_SD'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      u_traceri_rural_sd(icnt)=fld_full(wrf_vert(levl))*fac;        %ppbv
%      u_traceri_rural_sd(1)
%
      state_var='TCR2_U_RURAL_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      u_tcr2_rural_mn(icnt)=fld_full(wrf_vert(levl))*fac;            %ppbv
%      u_tcr2_rural_mn(1)
%
      state_var='WRFCMAQ_U_RURAL_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      u_wrfcmaq_rural_mn(icnt)=fld_full(wrf_vert(levl))*fac;         %ppbv
%      u_wrfcmaq_rural_mn(1)
%
      state_var='CAMCHEM_U_RURAL_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      u_camchem_rural_mn(icnt)=fld_full(wrf_vert(levl))*fac;         %ppbv
%      u_camchem_rural_mn(1)
%
% V field
      state_var='TRACER_I_V_CONUS_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      v_traceri_conus_mn(icnt)=fld_full(wrf_vert(levl))*fac;        %ppbv
%      v_traceri_conus_mn(1)
%
      state_var='TRACER_I_V_CONUS_SD'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      v_traceri_conus_sd(icnt)=fld_full(wrf_vert(levl))*fac;        %ppbv
%      v_traceri_conus_sd(1)
%
      state_var='TCR2_V_CONUS_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      v_tcr2_conus_mn(icnt)=fld_full(wrf_vert(levl))*fac;            %ppbv
%      v_tcr2_conus_mn(1)
%
      state_var='WRFCMAQ_V_CONUS_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      v_wrfcmaq_conus_mn(icnt)=fld_full(wrf_vert(levl))*fac;         %ppbv
%      v_wrfcmaq_conus_mn(1)
%
      state_var='CAMCHEM_V_CONUS_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      v_camchem_conus_mn(icnt)=fld_full(wrf_vert(levl))*fac;         %ppbv
%      v_camchem_conus_mn(1)
%
      state_var='TRACER_I_V_URBAN_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      v_traceri_urban_mn(icnt)=fld_full(wrf_vert(levl))*fac;        %ppbv
%      v_traceri_urban_mn(1)
%
      state_var='TRACER_I_V_URBAN_SD'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      v_traceri_urban_sd(icnt)=fld_full(wrf_vert(levl))*fac;        %ppbv
%      v_traceri_urban_sd(1)
%
      state_var='TCR2_V_URBAN_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      v_tcr2_urban_mn(icnt)=fld_full(wrf_vert(levl))*fac;            %ppbv
%      v_tcr2_urban_mn(1)
%
      state_var='WRFCMAQ_V_URBAN_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      v_wrfcmaq_urban_mn(icnt)=fld_full(wrf_vert(levl))*fac;         %ppbv
%      v_wrfcmaq_urban_mn(1)
%
      state_var='CAMCHEM_V_URBAN_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      v_camchem_urban_mn(icnt)=fld_full(wrf_vert(levl))*fac;         %ppbv
%      v_camchem_urban_mn(1)
%
      state_var='TRACER_I_V_RURAL_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      v_traceri_rural_mn(icnt)=fld_full(wrf_vert(levl))*fac;        %ppbv
%      v_traceri_rural_mn(1)
%
      state_var='TRACER_I_V_RURAL_SD'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      v_traceri_rural_sd(icnt)=fld_full(wrf_vert(levl))*fac;        %ppbv
%      v_traceri_rural_sd(1)
%
      state_var='TCR2_V_RURAL_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      v_tcr2_rural_mn(icnt)=fld_full(wrf_vert(levl))*fac;            %ppbv
%      v_tcr2_rural_mn(1)
%
      state_var='WRFCMAQ_V_RURAL_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      v_wrfcmaq_rural_mn(icnt)=fld_full(wrf_vert(levl))*fac;         %ppbv
%      v_wrfcmaq_rural_mn(1)
%
      state_var='CAMCHEM_V_RURAL_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      v_camchem_rural_mn(icnt)=fld_full(wrf_vert(levl))*fac;         %ppbv
%      v_camchem_rural_mn(1)
%
% Q field
      state_var='TRACER_I_Q_CONUS_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      q_traceri_conus_mn(icnt)=fld_full(wrf_vert(levl))*fac;        %ppbv
%      q_traceri_conus_mn(1)
%
      state_var='TRACER_I_Q_CONUS_SD'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      q_traceri_conus_sd(icnt)=fld_full(wrf_vert(levl))*fac;        %ppbv
%      q_traceri_conus_sd(1)
%
      state_var='TCR2_Q_CONUS_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      q_tcr2_conus_mn(icnt)=fld_full(wrf_vert(levl))*fac;            %ppbv
%      q_tcr2_conus_mn(1)
%
      state_var='WRFCMAQ_Q_CONUS_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      q_wrfcmaq_conus_mn(icnt)=fld_full(wrf_vert(levl))*fac;         %ppbv
%      q_wrfcmaq_conus_mn(1)
%
      state_var='CAMCHEM_Q_CONUS_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      q_camchem_conus_mn(icnt)=fld_full(wrf_vert(levl))*fac;         %ppbv
%      q_camchem_conus_mn(1)
%
      state_var='TRACER_I_Q_URBAN_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      q_traceri_urban_mn(icnt)=fld_full(wrf_vert(levl))*fac;        %ppbv
%      q_traceri_urban_mn(1)
%
      state_var='TRACER_I_Q_URBAN_SD'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      q_traceri_urban_sd(icnt)=fld_full(wrf_vert(levl))*fac;        %ppbv
%      q_traceri_urban_sd(1)
%
      state_var='TCR2_Q_URBAN_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      q_tcr2_urban_mn(icnt)=fld_full(wrf_vert(levl))*fac;            %ppbv
%      q_tcr2_urban_mn(1)
%
      state_var='WRFCMAQ_Q_URBAN_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      q_wrfcmaq_urban_mn(icnt)=fld_full(wrf_vert(levl))*fac;         %ppbv
%      q_wrfcmaq_urban_mn(1)
%
      state_var='CAMCHEM_Q_URBAN_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      q_camchem_urban_mn(icnt)=fld_full(wrf_vert(levl))*fac;         %ppbv
%      q_camchem_urban_mn(1)
%
      state_var='TRACER_I_Q_RURAL_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      q_traceri_rural_mn(icnt)=fld_full(wrf_vert(levl))*fac;        %ppbv
%      q_traceri_rural_mn(1)
%
      state_var='TRACER_I_Q_RURAL_SD'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      q_traceri_rural_sd(icnt)=fld_full(wrf_vert(levl))*fac;        %ppbv
%      q_traceri_rural_sd(1)
%
      state_var='TCR2_Q_RURAL_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      q_tcr2_rural_mn(icnt)=fld_full(wrf_vert(levl))*fac;            %ppbv
%      q_tcr2_rural_mn(1)
%
      state_var='WRFCMAQ_Q_RURAL_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      q_wrfcmaq_rural_mn(icnt)=fld_full(wrf_vert(levl))*fac;         %ppbv
%      q_wrfcmaq_rural_mn(1)
%
      state_var='CAMCHEM_Q_RURAL_MN'; 
      clear fld_full
      fld_full=double(ncread(data_file,state_var));
      q_camchem_rural_mn(icnt)=fld_full(wrf_vert(levl))*fac;         %ppbv
%      q_camchem_rural_mn(1)
      return
%
      HH = HH + incr;
      if(HH>=24)
