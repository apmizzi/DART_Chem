function plot_timeseries_TRACER_I_mean_and_stdv_CHEM_ics_CYCLE
   clear all;
%
...
%
   ...
   nz=50;
   num_mem=30;
   rc=system('rm -rf TRACER_I_MEAN_and_STDV_CHEM_IC_CYCLE_timeseries.eps');
   save_file='TRACER_I_MEAN_and_STDV_CHEM_IC_CYCLE_timeseries.eps';
%
% set colormap
