function plot_maps_histo_TRACER_I_spread_emis_DART
   clear all;
%
   DATE_STR_PR=["2005040218"];
   ...
   nz=20;
   num_mem=30;
   rc=system('rm -rf TRACER_I_SPREAD_EMIS_DART.eps');
   save_file='TRACER_I_SPREAD_EMIS_DART.eps';
%
% set colormap
