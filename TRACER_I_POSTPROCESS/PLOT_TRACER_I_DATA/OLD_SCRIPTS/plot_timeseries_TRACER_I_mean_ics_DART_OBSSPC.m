function plot_timeseries_TRACER_I_mean_ics_DART_OSPC
   clear all;
%
...
%
      ...
      for i=1:nx
        for j=1:ny
	    if((co_exp_po_mean(i,j)-co_exp_pr_mean(i,j,))~=0)
               co_cnt=co_cnt+1;
	    ...
	    if((o3_exp_po_mean(i,j)-o3_exp_pr_mean(i,j,))~=0)
               o3_cnt=o3_cnt+1;
               o3_exp_pr_gr_mean(idate)=o3_exp_pr_gr_mean(idate)+o3_exp_pr_mean(i,j);
               o3_exp_po_gr_mean(idate)=o3_exp_po_gr_mean(idate)+o3_exp_po_mean(i,j);
               o3_exp_pr_gr_vari(idate)=o3_exp_pr_gr_vari(idate)+o3_exp_pr_vari(i,j);
               o3_exp_po_gr_vari(idate)=o3_exp_po_gr_vari(idate)+o3_exp_po_vari(i,j);
            end
	    if((no2_exp_po_mean(i,j)-no2_exp_pr_mean(i,j,))~=0)
               no2_cnt=no2_cnt+1;
	    ...
	    if((so2_exp_po_mean(i,j)-so2_exp_pr_mean(i,j,))~=0)
               so2_cnt=so2_cnt+1;
	    ...
	    if((hcho_exp_po_mean(i,j)-hcho_exp_pr_mean(i,j,))~=0)
               hcho_cnt=hcho_cnt+1;
      ...
      if(o3_cnt~=0)
         o3_exp_pr_gr_mean(idate)=o3_exp_pr_gr_mean(idate)/o3_cnt;
         o3_exp_po_gr_mean(idate)=o3_exp_po_gr_mean(idate)/o3_cnt;
         o3_exp_pr_gr_vari(idate)=o3_exp_pr_gr_vari(idate)/o3_cnt;
         o3_exp_po_gr_vari(idate)=o3_exp_po_gr_vari(idate)/o3_cnt;
         o3_exp_pr_gr_stdv(idate)=sqrt(o3_exp_pr_gr_vari(idate));
         o3_exp_po_gr_stdv(idate)=sqrt(o3_exp_po_gr_vari(idate));
      else
         o3_exp_pr_gr_mean(idate)=NaN;
         o3_exp_po_gr_mean(idate)=NaN;
         o3_exp_pr_gr_vari(idate)=NaN;
         o3_exp_po_gr_vari(idate)=NaN;
      end
      if(no2_cnt~=0)
...
% O3
   if(~all(isnan(o3_exp_pr_gr_mean)) & ~all(isnan(o3_exp_po_gr_mean)))
...
% O3
   if(~all(isnan(o3_exp_pr_gr_stdv)) & ~all(isnan(o3_exp_po_gr_stdv)))
