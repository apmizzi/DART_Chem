function plot_maps_histo_TRACER_I_spread_ics_DART
   clear all;
%
   ...
   DATE_STR_PR=["2005040215"];
   DATE_STR_PO=["2005040218"];
   ndates=1;
   ...
   nz=50;
   num_mem=30;
   rc=system('rm -rf TRACER_I_SPREAD_IC_DART.eps');
   save_file='TRACER_I_SPREAD_IC_DART.eps';
%
% set colormap
...
%
   WRFCHEM_DART_DIR=strcat('dart_filter');
%
% CHEM DA
...
% Loop through dates
   for idate=1:ndates
      ...
      exp_pr=strcat(path_data,strcat('/',DATE_STR_PR(idate),'/wrfchem_cycle_cr/run_e001/wrfout_d01_',file_date));
%      if (idate==1)
%         exp_pr=strcat(path_data,strcat('/',DATE_STR_PR(idate),'/wrfchem_initial/run_e001/wrfout_d01_',file_date));
%      end
%
% GRID DATA
...
%
      ...
      for imem=1:num_mem
         ...
         exp_pr=strcat(path_data,strcat('/',DATE_STR_PR(idate),'/wrfchem_cycle_cr/',run_dir,'/wrfout_d01_',file_date));
%         if (idate==1)
%            exp_pr=strcat(path_data,strcat('/',DATE_STR_PR(idate),'/wrfchem_initial/',run_dir,'/wrfout_d01_',file_date));
%         end
         exp_po=strcat(path_data,strcat('/',DATE_STR_PO(idate),'/dart_filter/wrfout_d01_',file_date,'_filt',mem_chr));
%
...
%  PLOT CO FIELDS
      ...
      if(iplt==1)
         ...
         ytickformat('%5.2f')
         title(strcat('CO PR R-Sprd Chem-DART',{' '},SPRD_FAC_LBL),'Fontsize',18,'FontWeight','bold');
...
%
         ...
         ylabel('Probability','FontSize',16);
         ytickformat('%5.2f')
         title(strcat('CO PO R-Sprd Chem-DART',{' '},SPRD_FAC_LBL),'Fontsize',18,'FontWeight','bold');
...
% O3   
      if(iplt==1)
         ...
         ylabel('Probability','FontSize',16);
         ytickformat('%5.2f')
         title(strcat('O3 PR R-Sprd Chem-DART',{' '},SPRD_FAC_LBL),'Fontsize',18,'FontWeight','bold');
...
%
         ...
         ylabel('Probability','FontSize',16);
         ytickformat('%5.2f')
         title(strcat('O3 PO R-Sprd Chem-DART',{' '},SPRD_FAC_LBL),'Fontsize',18,'FontWeight','bold');
...
% NO2
      if(iplt==1)
         ...
         ylabel('Probability','FontSize',16);
         ytickformat('%5.2f')
         title(strcat('NO2 PR R-Sprd Chem-DART',{' '},SPRD_FAC_LBL),'Fontsize',18,'FontWeight','bold');
...
%
         ...
         ylabel('Probability','FontSize',16);
         ytickformat('%5.2f')
         title(strcat('NO2 PO R-Sprd Chem-DART',{' '},SPRD_FAC_LBL),'Fontsize',18,'FontWeight','bold');
...
% SO2
      if(iplt==1)
         ...
         ylabel('Probability','FontSize',16);
         ytickformat('%5.2f')
         title(strcat('SO2 PR R-Sprd Chem-DART',{' '},SPRD_FAC_LBL),'Fontsize',18,'FontWeight','bold');
...
%
         ...
         ylabel('Probability','FontSize',16);
         ytickformat('%5.2f')
         title(strcat('SO2 PO R-Sprd Chem-DART',{' '},SPRD_FAC_LBL),'Fontsize',18,'FontWeight','bold');
