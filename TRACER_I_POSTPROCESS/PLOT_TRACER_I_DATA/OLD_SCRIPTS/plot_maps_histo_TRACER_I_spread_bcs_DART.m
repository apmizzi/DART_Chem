function plot_maps_histo_TRACER_I_spread_bcs_DART
   clear all;
%
   DATE_STR_PR=["2011040203"];
   DATE_STR_PO=["2011040203"];
%   DATE_STR_PR=["2011040218"];
%   DATE_STR_PO=["2011040218"];
   ...
   zscal_bdy=20.;
   num_mem=30;
   rc=system('rm -rf TRACER-I_SPREAD_BC_DART.eps');
   save_file='TRACER_I_SPREAD_BC_DART.eps';
%
% set colormap
...
%
      ...
      for imem=1:num_mem
         ...
         exp_pr=strcat(path_data,strcat('/',DATE_STR_PO(idate),'/update_bc/wrfbdy_d01_',file_date,'_filt',run_dir))
%           exp_pr=strcat(path_data,strcat('/',DATE_STR_PO(idate),'/update_bc/wrfbdy_d01',run_dir))
%
% CO PRIOR BCs
         fac=1.e3;
         for ibdy=1:nbdy
